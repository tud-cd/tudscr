...
\ToDo{Index auf unnötige Befehle prüfen, mit \cs{DoNotIndex} entfernen}[v2.05]
\ToDo{Ist für \val{parameter} die Angabe von Makro/Umgebung möglich?}[v2.05]
\tableofcontents
\clearpage
...
\ToDo{Indexpräambel sprachabhängig: englische sichern + neue auf Deutsch}[v2.05]
\begingroup
  \makeatletter
