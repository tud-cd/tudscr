...
\ToDo{alle \cs{PassOptionsTo\dots} \emph{vor} \cs{ProcessOptions}}[v2.07]
\ToDo{%
  \cs{babelprovide[hyphenrules=ngerman-x-latest]{ngerman}} statt \pkg{hyphsubst}
}[v2.07]
\ToDo{tudscr.ins etc. an neue docstrip-Version anpassen}[v2.07]
\ToDo{\cs{LaTeX[e]} durch \cs{Logo} ersetzen}[v2.07]
