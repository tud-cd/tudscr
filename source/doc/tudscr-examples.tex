...
Hier wird gezeigt, wie die Präambel eines minimalen \Lettering{LaTeX}"=Dokumentes 
...
der daraus stammenden Befehl \Macro*(\Package{blindtext}){blinddocument} können 
weggelassen werden.
...
überfordert sein. Mit dem Tutorial \TUDScriptTutorial{treatise} soll etwas 
Licht ins Dunkel gebracht werden. Es erhebt jedoch keinerlei Anspruch, 
...
anderen \Lettering{LaTeX}"~Veteran~-- als Leitfaden für die Erstellung einer 
