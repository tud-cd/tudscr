...
Version~v2.8 mit etwas Vorsicht zu genießen, mehr dazu ist im Handbuch zu 
...
%
\ToDo{weiter im Text}
Nachfolgend wird die Tabelle gesetzt, das Ergebnis ist in 
\autoref{tab:tabularx} zu sehen.
%
\begin{Excerpt*}
\begin{table}
