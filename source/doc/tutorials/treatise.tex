...
einfügt. In \autoref{sec:tables} wird ein Ansatz aufgezeigt, wie man dies 
automatisiert über einen neuen Spaltenstil ausmerzen kann. Der Rest des Stils 
ist identisch zu \PValue{acrotabularx}.
%
\CodeHook{\let\newglossarystyle\renewglossarystyle}
\begin{Preamble*}
...
oder man definiert sich abermals einen entsprechenden Spaltentyp. Das ist für 
