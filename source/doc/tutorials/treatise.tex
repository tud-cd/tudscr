...
\end{quoting}
%
Mit \PName{Label} erfolgt die eindeutige Kennzeichnung des Symbols, gefolgt von 
der \PName{Bezeichnung} und dem Formelzeichen beziehungsweise \PName{Symbol} 
selbst sowie die dazugehörige physikalische \PName{Einheit}.
%
\begin{Tutorial}
\newcommand*{\newsymbol}[5][]{%
  \newglossaryentry{#2}{%
...
Textmodus ohne Probleme verwendet werden können. Etwas problematisch kann unter 
Umständen die Zuweisung des Labels zum Schlüssel \PValue{sort} sein. Hier ist 
eine manuelle Festlegung für diesen Schlüssel durch den Anwender über das 
optionale Argument eventuell sinnvoll. Für ein kleines Beispiel werden fünf 
Formelzeichen definiert\dots
%
\begin{Tutorial}
