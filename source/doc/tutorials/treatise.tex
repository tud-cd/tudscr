...
\Attention{%
  ...
  \hrfn{http://latex.wcms-file3.tu-dresden.de/phpBB3/viewtopic.php?t=427}{%
    Frage aus dem \Forum*%
  }
...
%
% TODO das muss raus, sobald \Package*{pst-pdf} wieder funktioniert
\setcounter{pspicture}{24}
\begin{Hint?}
\begin{figure}
