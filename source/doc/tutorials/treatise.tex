...
Ein kurzes Beispiel, wie eine Liste aussehen kann, nachdem die Möglichkeiten 
des Paketes \texttt{enumitem} genutzt und die vertikalen Abstände mit dem 
Befehl \texttt{\textbackslash setlist\{noitemsep\}} angepasst wurden.
\end{Trunk+}
\CodePreamble{%
...
\ToDo[imp]{Hinweis auf verschluckte Leerzeilen beim kopieren}[v2.02]
\ToDo[doc]{bad boxes überarbeiten}[v2.02]
\ListOfToDo
\end{document}
