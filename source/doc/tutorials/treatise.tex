...
Erfahrung mit dem Setzen von Tabellen mit \Lettering{LaTeX} haben, so wäre 
...
Diese stellt den Befehl \Macro(\Package{caption}){captionsetup} bereit. Mit 
...
dazugehörigen \Forum oder im \GitHubRepo'discussions' gestellt werden.
