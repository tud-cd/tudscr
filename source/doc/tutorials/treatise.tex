...
In \autoref{fig:example} wird dargestellt, wie eine Abbildung im PDF"~Format 
...
Die sicherlich einfachste Möglichkeit ist das Einbinden externer Abbildungen 
mit dem Befehl \Macro{includegraphics}(\Package{graphicx}) aus dem Paket 
\Package{graphicx}. Allerdings ist für eine wissenschaftliche Arbeit in 
höchster Qualität meiner Meinung nach das bloße Einfügen einer gescannten oder 
heruntergeladenen Abbildung unzureichend. Vielmehr sollte diese zum einen als 
...
Ähnlich wie zuvor bei der \Package{tikz}"~Grafik wird auch die nachfolgende 
\Package{pstricks}"~Grafik auf die Textbreite des Dokumentes skaliert, wobei 
