...
von \Macro{ttabbox} aus dem Paket \Package{floatrow}, um die Beschriftung an 
...
Ein Blindtext im Blocksatz zur Demonstration einer Z"~Spalte
\tabularnewline
\bottomrule
\end{tabu}}
\end{table}
...
Mit dem Paket \Package{ragged2e} kann diese hierfür aktiviert werden. Genaueres 
...
\ToDo{Zuordnen oder Erwähnen der Pakete}
\begin{Hint}
