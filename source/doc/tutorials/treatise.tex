...
kann später über \Parameter{Label} genutzt werden. Folgend werden sowohl drei 
Abkürzungen als auch eine Textpassage, in welcher selbige mit dem Befehl 
\Macro*{gls}\Parameter{label} verwendet werden, definiert.
%
\TutorialPreamble{\textbf{\textsf{Die Ausgabe der Textpassage}}}
\begin{Tutorial}
...
mit \Macro*{gls} von der zweiten (und jeder weiteren) unterscheidet.
