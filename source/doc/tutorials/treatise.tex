...
eine Einheit genau \unit[1]{\%} dieser entspricht. Außerdem werden noch ein 
...
ist dazu im Kapitel \manualhyperref{sec:tips:hyphenation}{Tipps \& Tricks} mehr 
...
Die meisten \hologo{LaTeX}-Schriftfamilien enthalten außerdem Ligaturen, die 
für einen typographisch sauberen Satz bei zusammengesetzten Wörtern, wie sie 
gerade im Deutschen relativ häufig vorkommen, aufgetrennt werden müssten. Mit 
der Anwendung \href{http://www.ctan.org/pkg/delig}{\Application{DeLig}} kann 
dies automatisiert geschehen. Wird \hologo{LuaLaTeX} als Dokumentprozessor 
genutzt, kann alternativ für dieses Unterfangen das Paket \Package{selnolig} 
verwendet werden.
...
\ToDo[doc]{Hinweis auf Verwendung von glossaries bzw. acro}
...
Satz mit \hologo{LaTeXe} dar. Allerdings wird es aus diesem Grund nur sehr 
\enquote{vorsichtig} weiterentwickelt. Für das Setzen neuer Dokumente sollte 
deswegen das Paket \Package{mathtools} verwendet werden, welches zwar auf 
\Package{amsmath} basiert, dieses allerdings um zusätzliche Funktionalitäten 
...
\ToDo[doc]{Zuordnen oder Erwähnen der Pakete}
