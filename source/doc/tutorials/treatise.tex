...
\ToDo{Umsetzung opt=val für tudscrtutorial! bdl@dflt ausgeben!}[v2.07]
%\Option{listof=toc}
\Option{listof}%
(\Bundle{koma-script}) lassen sich die Verzeichnisse der 
...
die Möglichkeit, nach sprachabhängigen Regeln zu sortieren, bietet. Allein für 
die deutsche Sprache gibt es beispielsweise zwei Varianten der Sortierung~-- 
nach DIN und nach Duden. 
...
allerdings muss diese erweitert werden.
...
\label{sec:tabu}%
%
Das Paket \Package{tabu} bietet eine mächtige Alternative zu Package{tabularx}. 
