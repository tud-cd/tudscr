...
\end{Preamble}
%
Zusätzlich wird das Paket \Package{mathswap}'manual', Damit können einerseits 
...
\footnote{%
  ...
  mit \Macro{mathswapon}'manual' wieder aktiviert.%
}
%
\CodePreamble{%
...
die beiden Befehle \Macro{commaswap}[\MPValue{\dots}]'manual' sowie 
\Macro{dotswap}[\MPValue{\dots}]'manual' genutzt werden. Mit diesen lässt 
