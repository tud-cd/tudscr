...
\begingroup%
  ...
  \hypersetup{%
    pdfauthor = {\@author},%
    pdftitle = {\@title},%
    pdfsubject = {Mathematiksatz mit \hologo{LaTeX}},%
...
\StartTutorial[%
  ...
  \hologo{LaTeX}"~Dokument. Sowohl bei der Einbindung von externen Daten als 
  ...
  \hologo{LaTeX} selbst zu bewerkstelligen.
...
\hologo{LaTeX} im mathematischen Modus bei der Angabe im deutschen 
...
\footnote{%
  ...
  Standardverhalten von \hologo{LaTeX} geschaltet. Die Funktionalität wird mit 
