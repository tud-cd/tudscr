...
\end{Trunk*}
%
Netter Nebeneffekt ist, dass man diesen Befehl aufgrund der Verwendung von 
\Macro{ensuremath}\PParameter{\dots} nun auch im Fließtext verwenden kann, 
beispielsweise hier \M{VM_{ind}} (\Macro{M}\PParameter{VM\_\PParameter{ind}}) 
für das induzierte Moment einer Verbrennungskraftmaschine.
