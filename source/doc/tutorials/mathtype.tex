...
Befehl \Macro{ind}\PParameter{\dots} für das Setzen von Indizes bei 
...
Gegensatz zur Standardbefehlsdefinition in \hologo{LaTeX2e}~-- \textbf{nach} 
...
wird \Macro{M} so definiert, das dieser entweder mit \Macro{M}\Parameter{Index} 
