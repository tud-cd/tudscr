...
in \hologo{LaTeXe}~-- \textbf{nach} dem obligatorischen noch ein optionales 
...
definiert, das dieser entweder mit \Macro{M}[\Parameter{Index}] oder in der 
Variante \Macro{M}[\Parameter{Index}\OParameter{Indexindex}] mit nachgelagertem 
