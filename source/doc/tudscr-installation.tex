...
\ChangedAt{%
  ...
  v2.04:Installationsskripte verbessert und robuster gestaltet sowie für 
        \TeXLive+ und \MiKTeX+ erweitert;%
  v2.06:Verwendung von \OpenSans erfordert \emph{keine} Schriftinstallation;%
}%
...
\Path{.\bsc\PName{Skript}.bat|Tee-Object -file \PName{Skript}.log} 
