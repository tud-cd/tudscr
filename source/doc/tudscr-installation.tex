...
\end{enumerate}
%
Damit ist die Installation der Schriften abgeschlossen. Bei der erstmaligen 
Verwendung einer der \TUDScript-Dokumentklassen werden folgende Pakete durch  
\Distribution{\hologo{MiKTeX}} nachinstalliert, falls diese nicht schon 
vorhanden sind:
%
\begin{itemize}
\item \Package{tudscr}
