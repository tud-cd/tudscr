...
bereitgestellt. Die aktuelle \vTUDScript{Version} kann nach der vollständigen 
...
\Attention{%
  ...
  \Bundle*{fontware} aus \Bundle*{collection-fontutils}
...
\begin{quoting}
\Path{%
  cd~"\$HOME/Downloads/TUD-Script\_fonts\_Unix"{}\,\OPValue{ENTER}
}\newline
\Path{bash tudscr\_fonts\_install.sh\,\OPValue{ENTER}}
\end{quoting}
...
\begin{quoting}[rightmargin=0pt]
  \Path{%
    ...
    TUD-Script\_fonts\_Windows"{}\,\OPValue{ENTER}%
  }\newline%
  \Path{%
    .\bsc tudscr\_fonts\_install.bat%
    |Tee-Object -file fonts\_install.log\,\OPValue{ENTER}%
  }%
\end{quoting}
%
...
\begin{quoting}
  ...
  \Path{%
    bash tudscr\_fonts\_install.sh > fonts\_install.log\,\OPValue{ENTER}%
  }%
\end{quoting}
%
...
\item Über das Kontextmenü die Kommandozeile ausführen und in dieser das Skript 
  ...
  \Path{tudscr\_fonts\_install.bat}\,\OPValue{ENTER}
  \end{quoting}
