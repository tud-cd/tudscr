...
Dazu werden die Archive \GitHubDownload*{TUD-Script_\vTUDScript{}_Windows.zip} 
für Windows beziehungsweise \GitHubDownload*{TUD-Script_\vTUDScript{}_Unix.zip} 
...
\minisec{Weitere Anforderungen für die Schriftinstallation}
...
Explorer heraus sondern über \Application*{Windows~PowerShell} ausgeführt 
werden. Hierfür ist die Eingabe von \enquote{PowerShell} im Startmenü von 
Windows mit einem nachfolgenden Öffnen mittels \OPValue{ENTER}"~Taste 
ausreichend. Danach muss mit \Path{cd} zum Ordner des Skriptes navigiert und 
...
\item Bei der erstmaligen Verwendung von \TUDScript werden alle benötigten 
  ...
  aktiviert ist und diese nicht schon vorhanden sind. Dies betrifft sowohl die 
  Bundle \Bundle{tudscr} und \Bundle{koma-script} als auch die Pakete 
  \Package*{xcolor}, \Package*{environ}, \Package*{trimspaces}, 
