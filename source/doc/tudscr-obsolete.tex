...
darauf hingewiesen.
\ToDo[doc]{%
  Hinweise zu Voreinstellungen der Optionen relspacing, cdoldfont, headings, 
  slantedgreek%
}[v2.06]
...
\ChangedAt*{v2.06:Änderungen gegenüber der vorhergehenden Version}%
\subsection{Änderungen für \TUDScript~v2.06}

\begin{Declaration}[v2.06]{\Option{cdoldfont}}
\printdeclarationlist%
\ToDo[doc]{Kompatibilitätseinstellung}[v2.06]
\end{Declaration}

\ToDo[doc]{Einträge in Änderungsliste prüfen}[v2.06]
\begin{Obsolete}{v2.06:\Option{cdoldfont=din}}[\Option{cdfont=\PSet}]{\Option{cdfont=din}}
\begin{Obsolete}{v2.06:\Option{cdoldfont=nodin}}{\Option{cdfont=nodin}}
\printobsoletelist%
...
%der Befehl \Macro{ifdin} zur Prüfung 
...
%und \Macro{dinbn} sowie \Macro{MakeTextUppercase}(\Package{textcase})'none' 
%zur 
...
%Version~v2.04 auch die beiden Befehle \Macro{cdfont} und \Macro{textcd} 
...
%%
%Für die Schriftauswahl der Überschriften aller Gliederungsebenen sind die 
%durch 
%\KOMAScript{} bereitgestellten Schriftelemente verantwortlich. Mehr dazu ist 
%in 
...
%  \end{minipage}%
%)%
%\ToDo{neue Schalter dokumentieren, keine explizite Deklaration}[v2.06]
%Alternativ zu den beschriebenen Textschaltern und "~kommandos können seit der 
%Version~v2.04 auch die beiden Befehle \Macro{cdfont} und \Macro{textcd} 
%verwendet werden, welche die gleiche Funktionalität wesentlich komfortabler 
%bereitstellen.
