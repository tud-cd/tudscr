...
%
\ToDo[doc]{Querverweis auf Option cd prüfen}[v2.05]
...
Sollte die Option \Option*{fontspec} dennoch genutzt werden, müssen alle auf 
das Paket \Package{fontspec} aufbauende Einstellungen durch den Anwender mit 
\Macro*{AfterPackage}\PParameter{fontspec}\PParameter{\dots} verzögert werden.
...
% sowie \Class{tudmathposter}|?|
  oder \TUDScript in der Version~v1.0 nie genutzt haben, können Sie dieses 
...
\Macro*{matriculationyear} sowie \Macro*{course}(tudscrsupervisor) und 
\Macro*{discipline}(tudscrsupervisor) aus dem Paket \Package*{tudscrsupervisor} 
