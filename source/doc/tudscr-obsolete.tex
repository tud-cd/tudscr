...
\Key*{\Macro{geometry}}{paper=\PName{Papierformat}}(\Package{geometry}),
\Key*{\Macro{geometry}}{layout=\PName{Zielformat}}(\Package{geometry}) und 
\Key*{\Macro{geometry}}{layoutoffset=\PName{Längenwert}}(\Package{geometry}) des
