...
über die Option~\Option{fontsize}(\Package{koma-script}) notwendig ist. Um 
kongruent zur Klasse \Class{tudmathposter} zu bleiben, ist eine Schriftgröße 
von \Option*{fontsize=\PValue{34\dots36pt}}(\Package{koma-script}) sinnvoll. 
...
\KOMAScript-Option \Option*{parskip=half-}(\Package{koma-script}) eingestellt 
