...
diese für Titel-, Teile- und Kapitelseiten (\Option*{chapterpage=true}) über die
Option \Option*{pageheadingsvskip} geändert werden. Für Kapitelüberschriften 
...
definiert und werden durch \Package{tudscrcomp} für die \TUDScript-Klassen in 
...
können. Für einen möglichst einfachen Übergang von \Class{tudmathposter} auf 
\Class{tudscrposter} kann ebenfalls das Paket \Package{tudscrcomp} geladen 
werden, welches im Anschluss die nachfolgenden Anwenderbefehle bereitstellt.

\begin{Declaration}[v2.05]{\Option{bluebg}}{%
  identisch zu \Option*{backgroundcolor=true}%
}
\printdeclarationlist%
%
...
\begin{Declaration}[v2.05]{\Option{tudmathposterfoot}}[true]
\printdeclarationlist%
%
\dots
\end{Declaration}
%
%\Option{tudmathposterfoot}\Option{cdfoot}
%
%\Macro{telefon}
%
%\Macro{fax}
...
\ToDo[doc]{Dokumentation \Class*{tudmathposter}}
\index{Kompatibilität!\Class{tudmathposter}|)}%
\end{Bundle*}
