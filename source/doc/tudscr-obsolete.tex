...
\Option*{cdoldfont=true} respektive \Option*{cdoldfont=onlydin}) aktiviert 
...
bleiben, ist \Macro*{NoCaseChange}(\Package{textcase}) zu verwenden.
%
\begin{Example}
...
\fullref{sec:tips:crop} zusätzliche Informationen zu finden.
\end{Declaration}
\index{Kompatibilität!\Class{tudmathposter}|)}%
\end{Bundle*}
