...
\printdeclarationlist*[\seeref{\Option*{cdfoot}'page'}]%
%
...
\printdeclarationlist*[%
  \emph{entfällt}, \seeref{\Option*{cleardoublespecialpage}'page'}%
]%
...
\printdeclarationlist*[\emph{entfällt}, \seeref{\Option*{abstract}'page'}]%
%
...
\printdeclarationlist*[\seeref{\Macro*{headlogo}'page'}]%
%
...
\printdeclarationlist*[\seeref{\Option*{tudbookmarks}'page'}]%
%
...
\printdeclarationlist*[\emph{entfällt}, \seeref{\Macro*{titledelimiter}'page'}]%
%
...
\printdeclarationlist*[\emph{entfällt}, \seeref{\Macro*{declaration}'page'}]%
%
...
\printdeclarationlist*[\emph{entfällt}, \seeref{\Environment*{task}'page'}]%
%
...
\printdeclarationlist*[%
  \emph{entfällt}, \seeref{\Length*{pageheadingsvskip}'page'}%
]%
...
}{\Key{\Environment{tudpage}}{head},\Key{\Environment{tudpage}}{foot}}
...
\printdeclarationlist*[\seeref{\Option*{cdgeometry}'page'}]%
%
...
\printdeclarationlist*[\seeref{\Option*{cdmath}'page'}]%
%
...
\printdeclarationlist*[\seeref{\Option*{cdhead}'page'}]%
%
...
\begin{Declaration}{\Environment{tudpage}[\OLParameter{Sprache}]}'
\begin{Declaration}[v2.03]{\Key{\Environment{tudpage}}{color}[\PName{Farbe}]}
\printdeclarationlist*%
%
