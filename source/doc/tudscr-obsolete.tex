...
\newcommand*\ChangesTo[1]{%
  ...
  \index[changelog]{%
    #1!Allgemein@Allgemein: \hyperref[{sec:obsolete:#1}]{%
...
\begin{Obsolete}{v2.00}{\Macro{logofile}[\MPName{Dateiname}]}'\Macro{headlogo}'%
\printdeclarationlist%
%
...
\begin{Obsolete}{v2.02}{\Macro{restriction}[\POList{Firma}]}%
  '\Macro{blocking}'
...
\begin{Declaration'}{\Environment{tudpage}[\PList]}
...
[\MPValue{fontspec}\MPValue{\dots}](\Bundle{koma-script}) verzögert werden. In 
