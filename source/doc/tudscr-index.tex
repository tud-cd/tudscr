\ToDo[imp]{see und Crossindex kombinieren}
% \SeeIndex[macros]{Befehle}{Makros,Parameter}
% \SeeIndex[Änderungsliste:changelog]{Änderungen}{Changelog,Version}
...
\CrossIndex{Änderungen,Kompatibilität}[Änderungsliste]{changelog}%
%
\index{LaTeX-Distribution@\Logo{LaTeX}-Distribution|see{Distribution}}%
\index{MacTeX@\Distribution{Mac\Logo{TeX}}|see{Distribution}}%
\index{TeX Live@\Distribution{\Logo{TeX}~Live}|see{Distribution}}%
\index{MiKTeX@\Distribution{\Logo{MiKTeX}}|see{Distribution}}%
%
