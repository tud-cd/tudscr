...
\index{Distribution!Mac\hologo{TeX}|see{Mac\hologoRobust{TeX}~{\idxfont(Distribution)}}}
\index{Distribution!\hologo{TeX}~Live|see{\hologoRobust{TeX}~Live~{\idxfont(Distribution)}}}
\index{Distribution!\hologo{MiKTeX}|see{\hologoRobust{MiKTeX}~{\idxfont(Distribution)}}}
...
\PrintIndexPrologue{%
  ...
  dem \TUDScript-Bundle liefern. Falls ein gesuchter Begriff hier nicht 
  auftaucht, ist das \Forum erster Anlaufpunkt.
}
\PrintIndex
\PrintChangelog
