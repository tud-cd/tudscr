...
diese nicht vorhanden sein, wird das Lesen der \Lettering{LaTeXe}"=Kurzbeschreibung
\href{http://mirrors.ctan.org/info/lshort/german/l2kurz.pdf}{\File{l2kurz.pdf}}
...
Des Weiteren sollte \emph{jeder} Anwender das \Lettering{LaTeXe}"=Sündenregister 
