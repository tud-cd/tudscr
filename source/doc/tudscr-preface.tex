...
\KOMAScript"=Klassen zurückzuschalten. Ohne die gezielte Verwendung der 
entsprechenden Optionen durch den Anwender werden per Voreinstellung alle 
Vorgaben des \CDs umgesetzt.
