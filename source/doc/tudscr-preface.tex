...
In diesem Handbuch werden die für das Erstellen von \Logo{LaTeX}"=Dokumenten 
...
bieten, welche weit über die Möglichkeiten der \Logo{LaTeX}"=Standardklassen 
...
Kenntnisse in der Verwendung von \Logo{LaTeX} vorausgesetzt. Sollten diese 
nicht vorhanden sein, wird das Lesen der \Logo{LaTeXe}"=Kurzbeschreibung 
...
in \Logo{LaTeX} stellt Nicola~L.~C.~Talbot sehr umfängliche Tutorials für 
\href{http://www.dickimaw-books.com/latex/novices/}{\Logo{LaTeX}-Novizen} 
...
Des Weiteren sollte \emph{jeder} Anwender das \Logo{LaTeXe}"=Sündenregister 
\InlineDeclaration{\File'CTANinfo:l2tabu/german'{l2tabu.pdf}} kennen, um 
...
in das \scrguide[dazugehörige Handbuch] sehr zu empfehlen, wenn nicht sogar 
unumgänglich.
