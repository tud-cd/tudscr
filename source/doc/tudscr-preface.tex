...
diese nicht vorhanden sein, wird das Lesen der \Lettering{LaTeX}"=Kurzbeschreibung
...
Des Weiteren sollte \emph{jeder} Anwender das \Lettering{LaTeX}"=Sündenregister 
