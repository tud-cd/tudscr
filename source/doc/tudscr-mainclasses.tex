...
\subsection{Vertikale Abstände in Abhängigkeit der gewählten Schriftgröße}
\ToDo[doc]{Option \Option{vspacing}}[v2.05]
...
\item[\PValue{2.03}]
  ...
  \Option{fontsize=\PName{Schriftgröße}} festgelegt werden.
  \Attention{%
  ...
  deaktivieren.
  \ToDo[doc]{Hinweis auf \Option{vspacing}}[v2.05]
\item[\PValue{2.04}]
  \index{Satzspiegel}%
  \ChangedAt{%
