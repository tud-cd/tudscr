...
die \KOMAScript-Option \Option{manualmark} nicht explizit angegeben, so werden
für \Option{cdfoot}[true] über die \KOMAScript-Option \Option{automark} auch 
...
Titel allein beschränkt. Auch bei der Angabe von Personen in den entsprechenden 
Feldern der Umgebungen \Environment{task}(tudscrsupervisor), 
\Environment{evaluation}(tudscrsupervisor) und 
\Environment{notice}(tudscrsupervisor) aus dem Paket \Package{tudscrsupervisor} 
