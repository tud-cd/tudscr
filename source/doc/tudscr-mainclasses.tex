...
der Optionenliste hat dabei die Form \PName{Option}\PValue{=}\PName{Wert}. Die 
...
\PName{Option} verwendet~-- so wird dieser Säumniswert verwendet.
...
falls über die Option \Option{cd=\PSet} eine farbige Ausprägung des Layouts 
eingestellt wurde. Mit der Angabe von \Option{cdsection=true} erschienen die 
...
\Macro*{setlength}[\PParameter{\Length{footlogoheight}}\Parameter{Längenmaß}]
...
\begin{Declaration}[%
  v2.05:Parameter für Prä- und Suffix bei der Datumsangabe;
