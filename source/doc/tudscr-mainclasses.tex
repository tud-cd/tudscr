...
farbig gesetzt, falls über die Option \Option{cd} eine farbige Ausprägung des 
Layouts eingestellt wurde. Mit \Option{cdsection}[true] werden die 
Überschriften der genannten Gliederungsebenen ohne Farbeinsatz gesetzt.
\end{Declaration}
