...
\begin{Declaration*}{\Macro{cdfontln}}
\begin{Declaration*}{\Macro{cdfontrn}}
\begin{Declaration*}{\Macro{cdfontbn}}
\begin{Declaration*}{\Macro{cdfontsn}}
\begin{Declaration*}{\Macro{cdfontxn}}
\begin{Declaration*}{\Macro{cdfontli}}
\begin{Declaration*}{\Macro{cdfontri}}
\begin{Declaration*}{\Macro{cdfontsi}}
\begin{Declaration*}{\Macro{cdfontbi}}
\begin{Declaration*}{\Macro{cdfontxi}}
\begin{Declaration*}{\Macro{textcdln}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdrn}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdsn}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdbn}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdxn}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdli}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdri}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdsi}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdbi}[\Parameter{Text}]}
\begin{Declaration*}{\Macro{textcdxi}[\Parameter{Text}]}
\printdeclarationlist
...
\begin{center}%
  \newcommand*\listfonts[2]{%
    \csuse{textcd#2}{Open Sans #1} & \Macro{cdfont#2} 
      & \Macro{textcd#2}[\Parameter{Text}]\tabularnewline
  }%
  \begin{tabular}{lll}%
    \toprule%
...
so werden zur Hausschrift passende Glyphen im Mathematikmodus genutzt, mit 
...
\ToDo[doc]{alles in eine Tabelle, explizite Deklaration der Basismakros}[v2.06]
...
\printdeclarationlist(%
  \begin{minipage}{-\tempdim}%
    ...
    \newcommand*\greekLetters{%
      % TODO die hier explizit deklarieren, Tabelle daneben
...
\begin{Declaration}[v2.06]{\Option{headings=\PSet}}
\printdeclarationlist%%
...
\itemfalse
  ...
  Serifenlosen der genutzten Schrift gesetzt. Ist die Hausschrift aktiviert, 
