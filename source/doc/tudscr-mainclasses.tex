...
\end{values}
%
Die Außenlinien des Querbalkens laufen entweder bis zum Text"~ oder bis zum 
Blattrand. Für den Fall, dass ein randloser Ausdruck technisch nicht möglich 
ist, können die Varianten bei denen der Querbalken bis an den Blattrand reicht 
Probleme bereiten. Deshalb kann mit der Option \Option{cdhead} die Breite des 
Querbalkens angepasst werden. Normalerweise ist der Balken auf die Textbreite 
begrenzt, lediglich im farbigen Layout wird dieser standardmäßig bis zum 
Blattrand verlängert.
%
\begin{values}
\item[textwidth/slim]
...
\ToDo[nxt,imp]{Text im Seitenfuß}[v2.04]
...
der verwendete Seitenstil angepasst werden. Gültige Werte für den Parameter 
sind \PValue{headings}, \PValue{plain}, \PValue{empty} oder einer der 
...
(\Option{cdtitle}[true]), können zusätzlich verschiedene Parameter im 
optionalen Argument verwendet werden, um die Nutzung der Schriften des \CDs zu 
regulieren sowie die Gestaltung von Kopf und Fuß zu beeinflussen. Alle 
...
\ToDo{Option umbenennen in cdtypearea, cdlayout oder ähnlich?}[v2.03]
