...
\end{values}
%
\ChangedAt{v2.02,v2.04!Einfachere Verwendung des Paketes \Package{fontspec}}
...
%
\ChangedAt{%
  v2.02!Seitenstil \PageStyle{plain.tudheadings} wird 
  genutzt!\Macro{partpagestyle}%
}[Implementierung]
...
\footnote{%
  \see*{\Macro{uppertitleback} und \Macro{lowertitleback}} im \scrguide*
}
...
%
\ToDo[imp,nxt]{Fehler \Macro{addchap} beheben, Paket \Package{footmisc}}[v2.06]
\ToDo[imp,nxt]{Zähler auch bei Sternversionen von Kapiteln zurücksetzen}[v2.06]
\ToDo[imp,nxt]{Fußnoten nicht ins Inhaltsverzeichnis?}[v2.06]
\ToDo[imp,nxt]{Problem mit \Package{hyperref} lösbar?}[v2.06]
