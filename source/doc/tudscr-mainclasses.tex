...
\Option{headingsvskip}, sowohl den Titel des Titelkopfes (\KOMAScript-Option 
\Option{titlepage=false}) als auch die Kapitelüberschrift bei deaktivierter 
Kapitelseite (\Option{chapterpage=false}) in ihrer vertikalen Position 
anzupassen.
\Attention{%
