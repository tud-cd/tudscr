...
etwa einer Höhe von 10\,mm, bei 100\,g/m² ca. 12\,mm. Demzufolge wäre die 
Bindekorrektur mit \Option*{BCOR=5mm}(\Package{typearea}) beziehungsweise 
\Option*{BCOR=6mm}(\Package{typearea}) bei diesem Beispiel zu wählen.%
\index{Satzspiegel|)}%
\end{Example}
