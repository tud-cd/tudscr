...
werden in \autoref{sec:math} erläutert. In \autoref{sec:tut:mathtype} sowie 
\autoref{sec:tut:mathswap} sind zusätzliche Hinweise zum typografisch guten 
...
\autoref{sec:tut:mathtype} sowie \autoref{sec:tut:mathswap} zu finden.
\index{Mathematiksatz|?)}%
