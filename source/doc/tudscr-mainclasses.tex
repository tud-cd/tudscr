...
\ToDo[doc]{Verwendung der Option \Option*{fontsize} dokumentieren?}[v2.04]
%
\begin{values}
\itemfalse
...
Normalerweise werden die Schriften des \CDs im PostScript"=Format verwendet, 
...
\begin{Declaration}[%
  ...
  v2.04!Wert \PValue{tocaggregate} neu%
...
\item[leveldown/tocleveldown/totocleveldown]
  ...
  obersten erzeugt.
\item[tocaggregate/totocaggregate]
  \ChangedAt{v2.04}
...
\item[aggregate/multi/multiple/all]
  \ChangedAt{v2.02}
...
\ToDo[doc]{Auswahl Schriftgrößendateien}[v2.04]