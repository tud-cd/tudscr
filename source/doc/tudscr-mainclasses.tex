...
\ToDo[imp]{Einbinden der \OpenSans mit \Package{fontspec}}[v2.06]
\ToDo[doc]{Hinweise zu Type1 und OTF überarbeiten}[v2.06]
\ToDo[doc]{Hinweise auf \Univers und \DIN raus}[v2.06]
...
ist lediglich das Paket \Package{opensans} notwendig. 
...
im PostScript- als auch im OpenType"=Format. Letztere werden ebenfalls durch
\ToDo[doc]{Name des Paketes für \OpenSans ergänzen/korrigieren}[v2.06]
das Paket \Package{opensans} bereitgestellt und werden nach dem Laden des 
Paketes \Package{fontspec} eingebunden.

\ToDo[doc]{Hinweise auf Schriftinstallation raus}[v2.06]
...
\ToDo[doc]{din/nodin raus > in \Option*{cdoldfont}}[v2.06]
\ToDo[doc]{lf/osf rein}[v2.06]
...
\begin{Declaration}[v2.02]{\Font{partsubtitle}}
\printdeclarationlist%
\index{Layout!Teileseiten|?}%
\index{Layout!Überschriften}%
\index{Schriftelemente}%
