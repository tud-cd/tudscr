...
\itemval*{true,light,lightfont,noheavyfont}
  ...
  (\seeplain{\Option{headings=\PMisc}'ppage'}), darunter liegende%
  \footnote{%
...
\begin{Declaration}
  {\Key{\Environment{tudpage}}{language=\PSet{Sprache}}}
\begin{Declaration}
  {\Key{\Environment{tudpage}}{columns=\PSet{Anzahl}}}
\begin{Declaration}
  {\Key{\Environment{tudpage}}{pagestyle=\PSet{Seitenstil}}}
  [v2.02]
\begin{Declaration}
  {\Key{\Environment{tudpage}}{cdfont=\PMisc}}
  <\seeplain{\Option{cdfont}'ppage'}>
\begin{Declaration}
  {\Key{\Environment{tudpage}}{cdhead=\PMisc}}
  <\seeplain{\Option{cdhead}'ppage'}>
  [v2.03]
\begin{Declaration}
  {\Key{\Environment{tudpage}}{cdfoot=\PMisc}}
  <\seeplain{\Option{cdfoot}'ppage'}>
  [v2.03]
\begin{Declaration}
  {\Key{\Environment{tudpage}}{headlogo=\PSet{Dateiname}}}
  <\seeplain{\Macro{headlogo}'ppage'}>
\begin{Declaration}
  {\Key{\Environment{tudpage}}{footlogo=\PSet{Dateinamenliste}}}
  <\seeplain{\Macro{footlogo}'ppage'}>
  [v2.03]
\begin{Declaration}
  {\Key{\Environment{tudpage}}{ddc=\PMisc}}
  <\seeplain{\Option{ddc}'ppage'}>
  [v2.02]
\begin{Declaration}
  {\Key{\Environment{tudpage}}{ddchead=\PMisc}}
  <\seeplain{\Option{ddchead}'ppage'}>
  [v2.02]
\begin{Declaration}
  {\Key{\Environment{tudpage}}{ddcfoot=\PMisc}}
  <\seeplain{\Option{ddcfoot}'ppage'}>
  [v2.02]
...
\begin{Declaration}
  ...
  [
    ...
    v2.02:Unterstützung der Schriftelemente 
      \Font*{titlepage}(\Bundle{koma-script}) und 
      \Font*{thesis}(\Bundle{koma-script}) 
...
\begin{Declaration}
  ...
  <\seeplain{\Option{cdgeometry}'ppage'}>
  [v2.06]
\begin{Declaration}
...
\itemval{color}
  ...
  des Titels aus.\footnote{%
    \seeplain{\Macro{uppertitleback}(\Bundle{koma-script}) und 
...
\begin{Declaration}
  {\Key{\Environment{abstract}}{language=\PSet{Sprache}}}
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.02]
\begin{Declaration}
  {\Key{\Environment{abstract}}{columns=\PSet{Anzahl}}}
\begin{Declaration}
  {\Key{\Environment{abstract}}{option=\PMisc}}
  <\seeplain{\Option{abstract}'ppage'}>
\printdeclarationlist
...
\begin{Declaration}
  {\Key{\Environment{declarations}}{language=\PSet{Sprache}}}
\begin{Declaration}
...
\begin{Declaration}
  {\Key{\Environment{declarations}}{place=\PSet{Ort}}}
\begin{Declaration}
  {\Key{\Environment{declarations}}{closing=\PSet{Ende}}}
\begin{Declaration}
  {\Key{\Environment{declarations}}{company=\PSet{Firma}}}
\printdeclarationlist
...
\begin{Declaration}
  {\Key{\Macro{confirmation}}{place=\PSet{Ort}}}
\begin{Declaration}
  {\Key{\Macro{confirmation}}{closing=\PSet{Ende}}}
\begin{Declaration}
  {\Key{\Macro{confirmation}}{language=\PSet{Sprache}}}
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.02]
\begin{Declaration}
  {\Key{\Macro{blocking}}{company=\PSet{Firma}}}
\begin{Declaration}
  {\Key{\Macro{blocking}}{language=\PSet{Sprache}}}
\begin{Declaration}
  {\Key{\Macro{blocking}}{markboth=\PMisc}}
\begin{Declaration}
  {\Key{\Macro{blocking}}{pagestyle=\PSet{Seitenstil}}}
\begin{Declaration}
  {\Key{\Macro{blocking}}{columns=\PSet{Anzahl}}}
\begin{Declaration}
...
\begin{Declaration}
  {\Key{\Macro{declaration}}{language=\PSet{Sprache}}}
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.02]
\begin{Declaration}
  {\Key{\Macro{declaration}}{columns=\PSet{Anzahl}}}
  [v2.02]
\begin{Declaration}
  {\Key{\Macro{declaration}}{option=\PMisc}}
\begin{Declaration}
  {\Key{\Macro{declaration}}{supporter=\PSet{Unterstützer}}}
\begin{Declaration}
  {\Key{\Macro{declaration}}{place=\PSet{Ort}}}
\begin{Declaration}
  {\Key{\Macro{declaration}}{closing=\PSet{Ende}}}
\begin{Declaration}
  {\Key{\Macro{declaration}}{company=\PSet{Firma}}}
\printdeclarationlist
