...
\begin{Declaration}{\Option{twoside=\PMisc}}[false][\Class{tudscrbook}:true]
\printdeclarationlist%
\index{Satzspiegel}%
\index{Papierformat}%
%
...
\begin{Entity}{\Bundle{koma-script}}
\begin{Declaration}{\Option{titlepage=\PMisc}}[true][\Class{tudscrartcl}:false]%
...
\InlineDeclaration{\Option{open=\PMisc}(\Bundle{koma-script})} auftreten. Wird 
ein neuer Teil oder ein neues Kapitel immer auf einer rechten Seite erzeugt 
