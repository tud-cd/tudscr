...
\Option'none'(\Bundle{koma-script}){parskip=\PName{Methode}} für die 
Absatzeinstellungen oder 
\Option'none'(\Package{typearea}){BCOR=\PName{Längenwert}} zur Festlegung der 
...
beiden \KOMAScript-Befehlen \Macro'none'(\Bundle{koma-script}){KOMAoptions} 
beziehungsweise \Macro'none'(\Bundle{koma-script}){KOMAoption}.
...
\itemval*{true,light,lightfont,noheavyfont}
  ...
  (\seeplain{\Option'ppage'{headings=\PMisc}}), darunter liegende%
  \footnote{%
    \Macro'none'(\Bundle{koma-script}){paragraph} und 
    \Macro'none'(\Bundle{koma-script}){subparagraph}%
...
(\seeplain{\Option{cdfont}}) definiert. Auf fette Mathematikschriften kann im 
...
die beiden Längen \Length'none'(\Bundle{koma-script}){abovecaptionskip} und 
\Length'none'(\Bundle{koma-script}){belowcaptionskip} für den Abstand zwischen 
einem Gleitobjekt~-- beispielsweise eine Abbildung oder eine Tabelle~-- und 
dessen mit \Macro'none'(\Bundle{koma-script},\Package{caption}){caption} 
...
\Option'none'(\Bundle{koma-script}){fontsize=\PName{Schriftgröße}} festgelegt 
werden.
\Attention{%
...
\Option|declare|'none'(\Package{typearea}){DIV=\PMisc} maßgeblichen Einfluss auf
...
\itemval{twoside,balanced}
  ...
  der \KOMAScript-Option \Option'none'(\Bundle{koma-script}){open=left} immer 
...
\itemval{custom}
  ...
  bereitgestellten Befehlen \Macro'none'(\Package{geometry}){geometry} und 
  \Macro'none'(\Package{geometry}){newgeometry} den Satzspiegel selbst 
...
\Option{cdfoot=\PSet{Höhe}} mit einem Längenwert verwendet werden. Dabei spielt 
es für beide Optionen keine Rolle, ob eine \Lettering{LaTeX}-Länge, ein 
\Lettering{TeX}-Abstand oder eine \Lettering{TeX}-Ausdehnung als Länge bei der 
...
\Option|declare|'none'(\Package{typearea}){BCOR=\PName{Längenwert}} zu 
...
(\Option{cdgeometry}) die Option \Option'none'(\Package{typearea}){BCOR} nutzen 
...
\Option|declare|'none'(\Package{typearea}){headinclude=\PBoolean} sowie 
\Option|declare|'none'(\Package{typearea}){footinclude=\PBoolean}.
...
Die Option \Option'none'(\Bundle{koma-script}){headings=\PMisc} wird bereits 
...
(%
  \Macro'none'(\Bundle{koma-script}){part}, 
  \Macro'none'(\Bundle{koma-script}){addpart}%
)
und Kapitelseiten 
(%
  \Macro'none'(\Bundle{koma-script}){chapter}, 
  \Macro'none'(\Bundle{koma-script}){addchap}%
)
...
\footnote{%
  ...
  \Macro(\Bundle{koma-script}){uppertitleback|\MPName{Titelrückseitenkopf}}
  und
...
\Macro'none'(\Bundle{koma-script}){part} und 
\Macro'none'(\Bundle{koma-script}){addpart} sowie deren Sternversionen 
...
Verwendung von \Macro'none'(\Bundle{koma-script}){chapter} beziehungsweise 
\Macro'none'(\Bundle{koma-script}){addchap} und den dazugehörigen 
...
\Macro'none'(\Bundle{koma-script}){section}, 
\Macro'none'(\Bundle{koma-script}){subsection}, 
\Macro'none'(\Bundle{koma-script}){subsubsection} sowie 
\Macro'none'(\Bundle{koma-script}){paragraph} und 
\Macro'none'(\Bundle{koma-script}){subparagraph}
...
(\KOMAScript-Option \Option'none'(\Bundle{koma-script}){titlepage=true}) als 
...
(\KOMAScript-Option \Option'none'(\Bundle{koma-script}){titlepage=false}) als 
...
\Macro'none'(\Bundle{koma-script}){pagestyle|\MPName{Seitenstil}} einer 
...
\footnote{%
  ...
  \Macro'none'(\Package{scrlayer-scrpage}){lefoot}, 
  \Macro'none'(\Package{scrlayer-scrpage}){cefoot} und 
  \Macro'none'(\Package{scrlayer-scrpage}){refoot} sowie 
  \Macro'none'(\Package{scrlayer-scrpage}){lofoot}, 
  \Macro'none'(\Package{scrlayer-scrpage}){cofoot} und 
  \Macro'none'(\Package{scrlayer-scrpage}){rofoot} respektive 
  \Macro'none'(\Package{scrlayer-scrpage}){ofoot}, 
  \Macro'none'(\Package{scrlayer-scrpage}){cfoot} und 
  \Macro'none'(\Package{scrlayer-scrpage}){ifoot}
  genutzt werden.%
}
...
\Macro'none'(\Bundle{koma-script}){pagestyle|\MPName{Seitentil}} aktiviert 
...
Auswahl von einem der \PageStyle{tudheadings}"=Seitenstilen nun zwischen diesen 
umgeschaltet wird.
...
beiden Seitenstile \PageStyle'none'(\Package{scrlayer-scrpage}){scrheadings}
oder \PageStyle'none'(\Package{scrlayer-scrpage}){plain.scrheadings} aktiviert 
werden.%
\end{Declaration}
\end{Declaration}
\end{Declaration}
...
\itemval*{true}
  ...
  (Klassenoption \Option'none'(\Package{typearea}){twoside=true}) die 
  Paginierung außen platziert wird.
\end{DeclareValues}

\index{Kolumnentitel}%
Wird beim Laden der Klasse respektive des Paketes \Package{scrlayer-scrpage} 
die Option \Option|declare|'none'(\Package{scrlayer-scrpage}){manualmark} nicht 
explizit angegeben, so werden mit \Option{cdfoot=true} über die 
\KOMAScript-Option \Option|declare|'none'(\Package{scrlayer-scrpage}){automark} 
...
\itemval{color,bicolor,bichrome}
  ...
  Variante genutzt wird (\seeplain{\Option{cdhead}}) oder eine Seite mit einem 
...
\Macro'none'(\Package{graphicx}){includegraphics} durchgereicht werden, um 
...
\Macro'none'(\Package{graphicx}){includegraphics} weitergereicht. Dies 
...
Argumente sind der Dokumentation des Paketes \Package{graphicx} zu entnehmen.
\end{Declaration}
\end{Declaration}
...
\begin{Declaration}
  {\Environment{tudpage/language=\PName{Sprache}}}
\begin{Declaration}
  {\Environment{tudpage/columns=\PName{Anzahl}}}
\begin{Declaration}
  {\Environment{tudpage/pagestyle=\PMisc}}
  [v2.02]
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.03]
\begin{Declaration}
  {\Environment{tudpage/headlogo=\PName{Dateiname}}}
  <\seeplain{\Macro'ppage'{headlogo}}>
\begin{Declaration}
  {\Environment{tudpage/footlogo=\PName{Dateinamenliste}}}
...
genutzte Sprache mit \Environment{tudpage/language=\PName{Sprache}}
...
Parameter \Environment{tudpage/columns=\PName{Anzahl}} der Inhalt der 
Umgebung mehrspaltig gesetzt. Mit \Environment{tudpage/pagestyle} kann 
...
\KOMAScript-Option 
\Option|declare|'none'(\Bundle{koma-script}){titlepage=\PBoolean} 
...
\begin{Declaration}
  {\Macro{maketitle/pagenumber=\PName{Seitenzahl}}}
  [v2.02]
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.03]
\begin{Declaration}
  {\Macro{maketitle/headlogo=\PName{Dateiname}}}
  <\seeplain{\Macro'ppage'{headlogo}}>
  [v2.03]
\begin{Declaration}
  {\Macro{maketitle/footlogo=\PName{Dateinamenliste}}}
  <\seeplain{\Macro'ppage'{footlogo}}>
  [v2.03]
\begin{Declaration}
...
\footnote{%
  \KOMAScript-Optionen \Option'none'(\Package{typearea}){twoside=true} und 
  \Option'none'(\Bundle{koma-script}){open=right}, Standard für 
  \Class{tudscrbook}%
}
...
(\KOMAScript-Option \Option'none'(\Bundle{koma-script}){titlepage=true}) im 
...
(Klassenoption~\Option|declare|'none'(\Package{typearea}){twocolumn}) wird mit 
...
(\KOMAScript-Option~\Option'none'(\Bundle{koma-script}){titlepage=true}) 
...
(\KOMAScript-Option~\Option'none'(\Bundle{koma-script}){titlepage=false}) zum 
...
\begin{Declaration}
  {\Macro{makecover/pagenumber=\PName{Seitenzahl}}}
  [v2.02]
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.03]
\begin{Declaration}
  {\Macro{makecover/headlogo=\PName{Dateiname}}}
  <\seeplain{\Macro'ppage'{headlogo}}>
  [v2.03]
\begin{Declaration}
  {\Macro{makecover/footlogo=\PName{Dateinamenliste}}}
  <\seeplain{\Macro'ppage'{footlogo}}>
  [v2.03]
\begin{Declaration}
...
\Macro'none'(\Bundle{koma-script}){coverpagetopmargin}, 
\Macro'none'(\Bundle{koma-script}){coverpageleftmargin}, 
\Macro'none'(\Bundle{koma-script}){coverpagerightmargin} sowie 
\Macro'none'(\Bundle{koma-script}){coverpagebottommargin} 
...
\Font'none'(\Bundle{koma-script}){titlehead}, 
\Font'none'(\Bundle{koma-script}){subject}, 
\Font'none'(\Bundle{koma-script}){title}, 
\Font'none'(\Bundle{koma-script}){subtitle}, 
\Font'none'(\Bundle{koma-script}){author}, 
\Font'none'(\Bundle{koma-script}){publishers},
\Font'none'(\Bundle{koma-script}){date} und 
\Font'none'(\Bundle{koma-script}){dedication}
...
Argument wird an \Macro'none'(\Package{hyperref}){hypersetup} aus besagtem
...
\Macro'none'(\Package{isodate}){printdate} von \Package{isodate} oder 
\Macro'none'(\Package{datetime2}){DTMDate} aus \Package{datetime2} genutzt. Mit 
...
\Environment(\Package{tudscrsupervisor}){task}-Umgebung genutzt werden, falls 
...
\begin{Declaration}
  ...
  [v2.05]
\begin{Declaration}
  {\Macro{date/before=\PName{Präfix}}}
  [v2.05]
\begin{Declaration}
  {\Macro{date/after=\PName{Suffix}}}
  [v2.05]
\begin{Declaration}
  {\Macro{date/place=\PName{Ort}}}
  [v2.05]
\begin{Declaration}
...
sein, so wird mit \Macro'none'(\Package{isodate}){printdate} beziehungsweise 
\Macro'none'(\Package{datetime2}){DTMDate} die durch das jeweilige Paket 
...
Der Befehl \Macro{thesis} dient den \TUDScript"=Hauptklassen außerdem zur 
...
\Macro'none'(\Bundle{koma-script}){footnote}, sondern mit der Anweisung 
...
Weise wie \Macro'none'(\Bundle{koma-script}){setpartpreamble} \emph{vor} der 
Verwendung von \Macro'none'(\Bundle{koma-script}){part} oder den davon 
...
Bezeichnung des mit 
\Macro'none'(\Bundle{koma-script}){part|\MPName{Bezeichnung}} erzeugten 
...
\itemval{false}
  ...
  \Macro'none'(\Bundle{koma-script}){setchapterpreamble} erzeugten 
...
\itemval*{true}
  ...
  respektive übernächsten Seite, \seeplain*{\Option{cleardoublespecialpage}}.
\end{DeclareValues}

\ChangedAt[\Macro(\Bundle{koma-script}){chapterpagestyle}]{%
  v2.02:nicht mehr abhängig von \Macro(\Bundle{koma-script}){partpagestyle}
}%
Mit \Macro*{renewcommand*|%
  \MPValue{\Macro'none'(\Bundle{koma-script}){chapterpagestyle}}%
  \MPName{Seitenstil}%
}
...
\Option|declare|'none'(\Bundle{koma-script}){chapterprefix=\PBoolean} 
...
gleicher Weise wie \Macro'none'(\Bundle{koma-script}){setchapterpreamble} 
\emph{vor} der Verwendung von \Macro'none'(\Bundle{koma-script}){chapter} oder 
...
\KOMAScript-Optionen \Option|declare|'none'(\Package{typearea}){twoside=\PMisc} 
und \Option|declare|'none'(\Bundle{koma-script}){open=\PName{Methode}} am 
Beginn von Teilen und Kapiteln in Dokumenten zu finden.%
\footnote{%
  Voreinstellungen
  \Class{tudscrbook}: 
  \Option'none'(\Package{typearea}){twoside=true}, 
  \Option'none'(\Bundle{koma-script}){open=right};
  \Class{tudscrartcl}, \Class{tudscrreprt}: 
  \Option'none'(\Bundle{koma-script}){open=any}, 
  \Option'none'(\Package{typearea}){twoside=false}%
}
Für die Vakatseiten kann der Seitenstil mit der \KOMAScript-Option 
\Option|declare|'none'(\Bundle{koma-script}){cleardoublepage=\PMisc} 
eingestellt werden.
...
aus.%
\footnote{%
  \KOMAScript-Option \Option'none'(\Package{typearea}){twoside=true} und 
  \Option'none'(\Bundle{koma-script}){open=right}%
}
...
\Option'none'(\Bundle{koma-script}){cleardoublepage} immer als vollständig 
...
\Option'none'(\Bundle{koma-script}){cleardoublepage} zu übernehmen. Des 
...
\itemval{false}
  ...
  \Option'none'(\Bundle{koma-script}){cleardoublepage}.
\itemval*{true}
  Der Seitenstil der Rückseite von Teilen und gegebenenfalls Kapiteln entspricht
  der Einstellung von \Option'none'(\Bundle{koma-script}){cleardoublepage} für 
  Vakatseiten.
\itemval{current}
  Für die erzeugte Rückseite wird der aktuell definierte Seitenstil 
  (\Macro'none'(\Bundle{koma-script}){pagestyle}) verwendet.
...
\Macro'none'(\Bundle{koma-script}){addtokomafont|\MPName{Schriftelement}\MPName{Einstellungen}}
...
\itemval{chapter,addchap}(\Class{tudscrbook})
  ...
  Es wird der Befehl \Macro'none'(\Bundle{koma-script}){chapter} für das 
...
\KOMAScript-Option \Option'none'(\Package{scrlayer-scrpage}){automark} 
...
\Option'none'(\Package{scrlayer-scrpage}){manualmark} manuelle Kolumnentitel 
...
\itemval{multiple,multi,all,aggregate}
  ...
  \Option'none'(\Package{typearea}){twocolumn} aktiviert, erfolgt die Ausgabe 
...
\itemval{fill,fil,vfil,vfill}
  ...
  (Klassenoption \Option'none'(\Package{typearea}){twocolumn}) nicht zur 
  Verfügung.
...
\begin{Declaration}
  {\Environment{abstract/language=\PName{Sprache}}}
\begin{Declaration}
  {\Environment{abstract/markboth=\PMisc}}
  [v2.02]
\begin{Declaration}
  {\Environment{abstract/pagestyle=\PName{Seitenstil}}}
  [v2.02]
\begin{Declaration}
  {\Environment{abstract/columns=\PName{Anzahl}}}
\begin{Declaration}
...
(\KOMAScript-Option \Option'none'(\Bundle{koma-script}){titlepage=false}), so 
wird eine Zusammenfassung~-- identisch zu den \KOMAScript-Klassen~-- in einer 
\Environment'none'(\Bundle{koma-script}){quotation}-Umgebung ausgegeben, 
...
\Option'none'(\Bundle{koma-script}){parskip=\PName{Methode}} nicht beachtet 
wird. Um dies zu beheben, kann das Paket \Package{quoting} geladen werden, 
wodurch stattdessen die Umgebung \Environment'none'(\Package{quoting}){quoting} 
verwendet wird.
...
optionalen Parameter \Environment{abstract/language=\PName{Sprache}}die 
...
beeinflusst werden. Wird \Environment{abstract/markboth=false} 
angegeben, werden automatische respektive manuelle Kolumnentitel verwendet. Die 
Einstellung \Environment{abstract/markboth=true} wiederum setzt diese 
für linke und rechte Seiten auf \Term{abstractname}. Zusätzlich lässt sich mit 
\Environment{abstract/markboth=\PSet{Kolumnentitel}} der 
Kolumnentitel direkt festlegen. So können die Kolumnen beispielsweise mit der 
Verwendung von \Environment{abstract/markboth=\MPValue{}} auch 
...
\Environment{abstract/columns=\PName{Anzahl}} die Zusammenfassung 
mehrspaltig gesetzt werden. Dem Parameter \Environment{abstract/option} 
...
\Macro'none'(\Bundle{koma-script}){setpartpreamble} beziehungsweise 
\Macro'none'(\Bundle{koma-script}){setchapterpreamble} verwendet, so wird die 
...
Mit dem \KOMAScript-Befehl \Macro'none'(\Bundle{koma-script}){renewcaptionname}
...
werden. Das Makro \Macro'none'(\Bundle{koma-script}){renewcaptionname} 
...
\Option'none'(\Bundle{koma-script}){titlepage=true} eine Titelseite verwendet 
wird.
...
\itemval{fill,fil,vfil,vfill}
  ...
  (Klassenoption \Option'none'(\Package{typearea}){twocolumn}) steht diese 
...
\begin{Declaration}
  {\Environment{declarations/language=\PName{Sprache}}}
\begin{Declaration}
  {\Environment{declarations/markboth=\PMisc}}
\begin{Declaration}
  {\Environment{declarations/pagestyle=\PName{Seitenstil}}}
\begin{Declaration}
  {\Environment{declarations/columns=\PName{Anzahl}}}
\begin{Declaration}
  {\Environment{declarations/option=\PMisc}}
\begin{Declaration}
  {\Environment{declarations/supporter=\PName{Unterstützer}}}
\begin{Declaration}
  {\Environment{declarations/place=\PName{Ort}}}
\begin{Declaration}
  {\Environment{declarations/closing=\PName{Ende}}}
\begin{Declaration}
  {\Environment{declarations/company=\PName{Firma}}}
\printdeclarationlist
...
Parameter \Environment{declarations/language=\PName{Sprache}} für die 
...
\ChangedAt{v2.02}%
\index{Kolumnentitel}%
Die Kolumnentitel können mit \Environment{declarations/markboth} 
beeinflusst werden. Mit \Environment{declarations/markboth=true} werden 
für diese auf linker und rechter Seite \Term{confirmationname} beziehungsweise
\Term{blockingname} verwendet.
Automatische (\Option'none'(\Package{scrlayer-scrpage}){automark}) respektive 
manuelle (\Option'none'(\Package{scrlayer-scrpage}){manualmark}) Kolumnentitel 
werden mit \Environment{declarations/markboth=false} genutzt. Mit 
\Environment{declarations/markboth=\PSet{Kolumnentitel}} können 
diese direkt festgelegt werden. Wird \Environment{declarations/markboth} 
...
\Environment{declarations/pagestyle} auch manuell angegeben. Wurde das 
Paket \Package{multicol} geladen, wird der Inhalt der Umgebung mit 
\Environment{declarations/columns=\PName{Anzahl}} mehrspaltig gesetzt. 
Für \Environment{declarations/option} können alle gültigen Werte der 
Option \Option{declaration} angegeben werden. Die Verwendung der weiteren 
Parameter \Macro{confirmation/supporter} sowie 
\Macro{confirmation/place} und \Macro{confirmation/closing} ist 
in der Dokumentation des Befehls \Macro{confirmation} zu finden, der Parameter 
\Macro{blocking/company} ist für \Macro{blocking} erläutert.
\end{Declaration}
\end{Declaration}
\end{Declaration}
\end{Declaration}
...
\begin{Declaration}
  ...
  [v2.05]
\begin{Declaration}
  {\Macro{confirmation/supporter=\PName{Unterstützer}}}
\begin{Declaration}
  {\Macro{confirmation/place=\PName{Ort}}}
\begin{Declaration}
  {\Macro{confirmation/closing=\PName{Ende}}}
\begin{Declaration}
  {\Macro{confirmation/language=\PName{Sprache}}}
\begin{Declaration}
  {\Macro{confirmation/markboth=\PMisc}}
  [v2.02]
\begin{Declaration}
  {\Macro{confirmation/pagestyle=\PName{Seitenstil}}}
  [v2.02]
\begin{Declaration}
  {\Macro{confirmation/columns=\PName{Anzahl}}}
  [v2.02]
\begin{Declaration}
...
\Macro{confirmation/supporter} oder \emph{zuvor} mit dem Befehl 
...
\begin{Declaration}
  ...
  [v2.02]
\begin{Declaration}
  {\Macro{blocking/company=\PName{Firma}}}
\begin{Declaration}
  {\Macro{blocking/language=\PName{Sprache}}}
\begin{Declaration}
  {\Macro{blocking/markboth=\PMisc}}
\begin{Declaration}
  {\Macro{blocking/pagestyle=\PName{Seitenstil}}}
\begin{Declaration}
  {\Macro{blocking/columns=\PName{Anzahl}}}
\begin{Declaration}
...
\begin{Declaration}
  ...
  [v2.05]
\begin{Declaration}
  {\Macro{declaration/language=\PName{Sprache}}}
\begin{Declaration}
  {\Macro{declaration/markboth=\PMisc}}
  [v2.02]
\begin{Declaration}
  {\Macro{declaration/pagestyle=\PName{Seitenstil}}}
  [v2.02]
\begin{Declaration}
  {\Macro{declaration/columns=\PName{Anzahl}}}
  [v2.02]
\begin{Declaration}
  {\Macro{declaration/option=\PMisc}}
\begin{Declaration}
  {\Macro{declaration/supporter=\PName{Unterstützer}}}
\begin{Declaration}
  {\Macro{declaration/place=\PName{Ort}}}
\begin{Declaration}
  {\Macro{declaration/closing=\PName{Ende}}}
\begin{Declaration}
  {\Macro{declaration/company=\PName{Firma}}}
\printdeclarationlist
...
\Macro'none'(\Package{hyperref}){pdfbookmark} aus \Package{hyperref}. Die 
...
\Macro'none'(\Bundle{koma-script}){providecaptionname|\MPName{Sprache}\MPName{Makro}\MPName{Inhalt}}
...
\Macro'none'(\Bundle{koma-script}){renewcaptionname|\MPName{Sprache}\MPName{Makro}\MPName{Inhalt}}
...
beziehungsweise \Macro*{thesis} und \Macro*'full'{subject} zu finden.
\TermTable{%
...
\footnote{%
  \Macro{confirmation|\OPValue{\Macro{confirmation/supporter=\PName{Unterstützer}}}}
...
\footnote{%
  \Macro{blocking|\OPValue{\Macro{blocking/company=\PName{Firma}}}}
...
%}
%%
%\begin{DeclareValues}{\Option{footnotes}}
