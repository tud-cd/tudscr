...
]{\Option{cdfont=\PSet}}[true,normalbold]%
\printdeclarationlist%
%
...
\item[normalbold]
  \ChangedAt{v2.05}
  Für fette Schriftschnitte wird \texturn{Univers~55~Regular} beziehungsweise 
...
\begin{Declaration}[v2.05]{\Option{footlogoheight=\Parameter{Längenwert}}}%
\printdeclarationlist%
%
...
\Option{footlogoheight=\Parameter{Längenwert}} gesetzt wird. Sollte die Höhe 
des Fußbereiches nicht ausreichen, um alle Logos in der gewünschten Größe 
...
dabei den Inhalt der rechten Spalte zu verändern.
...
Schrifteinstellungen respektive \PName{Anweisungen} ausgeführt werden. 
Soll die Definition des Inhalts im Fußbereich ohne eine automatische Anpassung 
der Schriftgröße erfolgen, so ist die Sternversion \Macro{footcontent*} zu 
nutzen. Auch hier lässt sich gegebenenfalls das optionale Argument für die 
...
\Environment{task}"=Umgebung aus dem Paket \Package{tudscrsupervisor} genutzt 
werden, falls diese denn zum Einsatz kommt.
\end{Declaration}
\end{Declaration}
\end{Declaration}
\end{Declaration}
