...
genutzte Sprache mit \Key{\Environment{tudpage}}{language=\PValueName{Sprache}}
...
Parameter \Key{\Environment{tudpage}}{columns=\PValueName{Anzahl}} der Inhalt 
der Umgebung mehrspaltig gesetzt. Mit \Key{\Environment{tudpage}}{pagestyle} 
kann der Seitenstil angepasst werden, wobei \PValue{headings}, \PValue{plain} 
und \PValue{empty} gültige Werte sind. 
...
optionalen Parameter \Key{\Environment{abstract}}{language=\PValueName{Sprache}}
...
\Key{\Environment{abstract}}{columns=\PValueName{Anzahl}} die Zusammenfassung 
...
Parameter \Key{\Environment{declarations}}{language=\PValueName{Sprache}} für 
die \Environment{declarations}"=Umgebung geändert werden. Dadurch werden die 
...
\Key{\Environment{declarations}}{columns=\PValueName{Anzahl}} mehrspaltig 
gesetzt. Für \Key{\Environment{declarations}}{option} können alle gültigen 
Werte der Option \Option{declaration} angegeben werden. Die Verwendung der 
weiteren Parameter \Key{\Macro{confirmation}}{supporter} sowie 
...
\footnote{%
  \Macro{confirmation}[\POParameter{%
    \Key{\Macro{confirmation}}{supporter=\PValueName{Unterstützer}}%
  }]
...
\footnote{%
  \Macro{blocking}[%
    \POParameter{\Key{\Macro{blocking}}{company=\PValueName{Firma}}}%
  ]
