...
\begin{Declaration}[%
  ...
  v2.03:erweitert, Optionen \Option{cdfonts} und \Option{din} integriert%
...
\begin{Declaration}[%
  v2.03:neue Farbvarianten (\protect\PValue{bicolor} und 
  \protect\PValue{fullcolor});%
...
\end{values}
%
Wird der Option mit \Option{cdfoot=\PValueName{Höhe}} ein Längenmaß übergeben, 
entspricht dies der Verwendung von \Option{extrabottommargin=\PName{Höhe}}.
\end{Declaration}
...
für die farbliche Ausprägung (Option \Option{cd}) automtisch gewählt. Soll dies 
manuell erfolgen, können folgende Werte verwendet werden:
%
\begin{values}{\Option{ddc}}
\item[color]
...
\begin{Declaration}[%
  v2.02:Trennung einzelner Teile mit \Macro{nextabstract}%
...
\begin{Declaration}[v2.02]{\Key{\Environment{declarations}}{markboth=\PSet}}
\begin{Declaration}[v2.02]{%
...
\begin{Declaration}[v2.02]{\Key{\Macro{blocking}}{markboth=\PSet}}
