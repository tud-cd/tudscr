...
\Key{\Environment{abstract}}{markboth=\PName{Kolumnentitel}} der 
...
\Key{\Environment{declarations}}{markboth=\PName{Kolumnentitel}} können diese 
direkt festgelegt werden. Wird \Key{\Environment{declarations}}{markboth} in 
irgendeiner Form genutzt, wird der Seitenstil \PageStyle{headings} automatisch 
gesetzt. Dieser lässt sich für die Umgebung mit dem Parameter 
