...
\begin{Declaration}[%
  ...
  \Macro{footcontent}[%
    \OPName{Anweisungen}\MPName{Inhalt}\OPName{Inhalt}%
  ]%
}
\begin{Declaration}[v2.04]{%
  \Macro{footcontent*}[%
...
\begin{Declaration}[v2.02]{\Key{\Environment{tudpage}}{pagestyle=\PMisc}}
...
\begin{Declaration}{%
  \Macro{maketitleonecolumn}[%
    \OPList{Seitenzahl}\MPName{Einspaltentext}%
  ]%
}
\printdeclarationlist%
\index{Satzspiegel!doppelseitig}%
