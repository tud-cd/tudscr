...
%
\ToDo[doc]{vor begin document verwenden oder scrlayer-scrpage einbinden}[v2.04]
\ChangedAt*{%
...
\ToDo[imp]{Text im Seitenfuß}[v2.04]
\begin{Declaration}[%
...
\index{Satzspiegel!doppelseitig}\index{Leerseiten}%
%
\ToDo[imp]{Sonderbehandlung für Teile- und Kapitelrückseiten?}[v2.04]
% http://latex.wcms-file3.tu-dresden.de/phpBB3/viewtopic.php?f=11&t=396
...
\item[tocmultiple/totocmultiple/tocaggregate/totocaggregate]
  \ChangedAt{v2.04}
  Es wird ein Inhaltsverzeichniseintrag für \emph{alle} Zusammenfassungen 
  erstellt.
\end{values}
%
\ChangedAt{v2.02}
...
\item[tocmultiple/totocmultiple/tocaggregate/totocaggregate]
  \ChangedAt{v2.04}
  Es wird ein Inhaltsverzeichniseintrag für \emph{alle} Erklärungen erstellt.
\end{values}
%
\ChangedAt{v2.02}
...
\ToDo[doc]{variable Abstände von Schriftgröße abhängig}[v2.04]