...
\ChangedAt*{%
  ...
  v2.07:Glyphen im Mathematiksatz werden passend zu den mit \Option{cdfont}
...
\Macro*{up\MPName{Letter}} oder \Macro*{it\MPName{Letter}} auch der Präfix 
\Macro*{other\MPName{Letter}} genutzt werden. Damit wird~-- abhängig von der 
...
\begin{Declaration}[%
  v2.05;%
  v2.07:beachtet alle Schriftgrößen (\Option{fontsize}) kontinuierlich;%
...
\begin{Declaration}{\Macro{headlogo}[\PList\MPName{Dateiname}]}
\printdeclarationlist%
\index{Layout!Kopfzeile}%
\index{Layout!Zweitlogo|?}%
...
\begin{Declaration}[v2.03]{\Macro{footlogo}[\PList\MPName{Dateinamenliste}]}
...
\begin{Declaration}{\Environment{tudpage}[\POList{Sprache}]}
...
]{\Macro{maketitle}[\POList{Seitenzahl}]}
\begin{Declaration}[v2.02]{%
...
\begin{Declaration}{%
  \Macro{maketitleonecolumn}[\POList{Seitenzahl}\MPName{Einspaltentext}]%
}
\printdeclarationlist%
\index{Satzspiegel!doppelseitig}%
...
]{\Macro{makecover}[\POList{Seitenzahl}]}
\begin{Declaration}[v2.02]{%
...
]{\Macro{date}[\POList{Suffix}\MPName{Datum}]}
\begin{Declaration}[v2.05]{\Macro{date*}[\POList{Suffix}\MPName{Datum}]}
...
]{\Environment{abstract}[\POList{Sprache}]}
\begin{Declaration}{\Macro{nextabstract}[\POList{Sprache}]}
...
]{\Environment{declarations}[\POList{Sprache}]}
\begin{Declaration}{%
  \Macro{nextdeclaration}[%
    \POList{Sprache}\MPName{Überschrift}\MPName{Erklärung}%
  ]%
}
...
\begin{Declaration}{\Macro{confirmation}[\POList{Unterstützer}]}
\begin{Declaration}[v2.05]{\Macro{confirmation*}[\PList]}
...
\begin{Declaration}[v2.02]{\Macro{blocking}[\POList{Firma}]}
...
\begin{Declaration}{\Macro{declaration}[\PList]}
\begin{Declaration}[v2.05]{\Macro{declaration*}[\PList]}
