...
\begin{Declaration}[%
  v2.02!Werte für Optionen \Option{cdbar} und \Option{fontspec} ergänzt%
...
\Rename[options]{v2.03}{\Option{barfont}}{\Option{cdbar}}
\ToDo[imp]{cdbar}[v2.03]
\ToDo[doc]{cdbar aus barfont und widehead zusammenführen}[v2.03]
\begin{Declaration}[v2.03]{\Option{cdbar}[\PSet]}%
  [true][\Option{cdfont}[false]:false]
\printdeclarationlist%
...
\begin{Declaration}[v2.02]{\Key{\Environment{tudpage}}{cdbar}[\PSet]}
...
\Option{ddcfoot}'full' als auch \Option{cdbar} und \Option{widehead}'page'. 
