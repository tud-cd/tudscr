...
%
\ToDo{InlineDeclaration mit Label ohne Indexeintrag}[v2.06f]
...
\begin{Declaration}[%
  v2.05;%
  v2.06f:beachtet alle Schriftgrößen (\Option{fontsize}) kontinuierlich;%
...
\index{Layout!Fußzeile}%
\index{Layout!Dresden-concept-Logo@\DDC-Logo}%
\ToDo{Umbruch, eine Zeile mehr Text!}[v2.06f]
%
