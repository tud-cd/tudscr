...
Schriftgrößenabhängigkeit 
%von \Length{bigskipamount}, \Length{medskipamount} und \Length{smallskipamount}
für vertikalen Leerraum zwischen zwei Absätzen sowie 
%\Length{abovecaptionskip} und  \Length{belowcaptionskip} 
%für den Abstand 
bei Beschriftungen als auch 
%\Length{columnsep}, 
für den horizontalen Abstand der einzelnen Textspalten untereinander im 
mehrspaltigen Layout
%,
 anpassen.
%
\begin{values}{\Option{vspacing}}
\itemfalse[absolute/standard]
  Die Längen für vertikalen Leerraum werden nicht angepasst, passende Werte 
  sollten bei einer Änderung der Schriftgröße durch den Anwender gewählt werden.
\itemtrue*[relative/fontsize]
  In Abhängigkeit von der gewählten Schriftgröße werden die Längen für 
  vertikalen Leerraum automatisch festgelegt.
\end{values}
\end{Declaration}
...
Satzspiegel nach dem \TUDCD berechnet respektive erstellt werden soll. 
\begin{values}{\Option{cdgeometry}}
\item[restricted]
