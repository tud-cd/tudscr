...
\ToDo[doc]{Kompatibilitätsmodus v2.02 zu später: \Option{tudscrver}}[v2.03]
...
%
Bla\meaning\textbardbl
%
\begin{values}
\item[\PValue{v2.02}] Bla Satzspiegel\dots
  Mit der Wahl \Option{tudscrver}[\PValue{first}] wird diese Einstellung 
  ebenfalls aktiviert.
\ToDo[doc]{Satzspiegel~-- DDC}[v2.03]
\end{values}
\end{Declaration}
