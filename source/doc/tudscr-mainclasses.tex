...
\Length{abovecaptionskip}(\Package{koma-script})'none' und 
\Length{belowcaptionskip}(\Package{koma-script})'none' für den Abstand zwischen 
einem Gleitobjekt und dessen mit 
\Macro{caption}(\Package{koma-script},~\Package{caption})'none' gesetzten 
Beschreibung. Außerdem wird die Länge \Length{columnsep} als Maß für den 
Abstand der einzelnen Textspalten im zwei- oder mehrspaltigen Layout in 
Relation zur Schriftgröße festgelegt.
...
\footnote{\raggedright%
  ...
  \Macro{date}[\Parameter{Datum}], \Macro{and}, 
  \Macro{thanks}[\Parameter{Fußnote}](\Package{koma-script}) und 
...
Mit der Angabe von \Option{cdsection=true} erschienen die Überschriften der 
