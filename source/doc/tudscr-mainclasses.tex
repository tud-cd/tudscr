...
\Option{parskip=\PSet}(\Package{koma-script}) für die Absatzeinstellungen oder 
...
\index{Schriftstärke}%
%
Die Option \Option{headings=\PSet} wird bereits von \KOMAScript{} definiert und 
...
]{\Option{cdtitle=\PSet}}[\Option{cd=\PSet}]<\cdalias>
\printdeclarationlist%
\index{Titel|?}%
%
...
]{\Option{cdcover=\PSet}}[true][\Option{cd=false}:false]<\cdalias>
\printdeclarationlist%
\index{Umschlagseite|?}%
%
...
]{\Option{cdpart=\PSet}}[\Option{cd=\PSet}]<\cdalias>
\printdeclarationlist%
...
]{\Option{cdchapter=\PSet}}[\Option{cd=\PSet}]<\cdalias>
\printdeclarationlist%
...
\Option{footlogoheight=\PLength} gesetzt wird. Sollte die Höhe des 
Fußbereiches nicht ausreichen, um alle Logos in der gewünschten Größe 
darstellen zu können, kann diese über \Option{extrabottommargin=\PLength} 
...
diese über \Option{extrabottommargin=\PLength} respektive 
...
und \Option{open=\PSet}(\Package{koma-script})|declare| am Beginn von Teilen 
...
]{\Option{abstract=\PSet}}[false,notoc][\Class{tudscrbook}:chapter,toc]%
\printdeclarationlist%
\index{Satzspiegel!zweispaltig}%
%
...
auf einer Seite deaktiviert werden. Diese folgend beschriebenen Einstellungen 
zur Positionierung der Zusammenfassungen sind lediglich innerhalb der 
\Environment{abstract}"~Umgebung wirksam, wenn sowohl eine Titelseite
(\KOMAScript-Option \Option{titlepage=true}(\Package{koma-script})) als auch 
...
\Option{parskip=\PSet}(\Package{koma-script}) nicht beachtet wird. Um dies zu 
...
]{\Option{declaration=\PSet}}[true,notoc][\Class{tudscrbook}:chapter,toc]%
\printdeclarationlist%
%
...
\begin{Declaration}[v2.03]{\Option{tudscrver=\PSet}}[last]
\printdeclarationlist%
