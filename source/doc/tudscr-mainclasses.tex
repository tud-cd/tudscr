...
die Option \Option{manualmark} nicht explizit angegeben, so werden durch 
\Option{cdfoot=true} über die \KOMAScript-Option \Option{automark} auch 
...
\footnote{%
  \KOMAScript-Optionen \Option{twoside} und \Option{open=right}, Standard für 
  \Class{tudscrbook}
}
...
} Mit der \KOMAScript"=Option \Option{cleardoublepage} kann für die Vakatseiten 
...
aus.\footnote{\KOMAScript"=Option \Option{twoside} und \Option{open=right}} 
...
\index{Satzspiegel!doppelseitig}%
%
Sollten beim farbigen Layout die \KOMAScript-Optionen \Option{twoside} sowie 
...
der \scrguide[Dokumentation von \KOMAScript] zu finden.
%
\begin{values}
\itemfalse
...
\item[\PValue{2.03}]
  ...
  Schriftgröße definiert, welche durch die \KOMAScript-Option \Option{fontsize} 
