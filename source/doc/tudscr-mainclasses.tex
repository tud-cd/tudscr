...
\itemval=custom=[v2.05]
  ...
  das Paket bereitgestellten Befehlen \InlineDeclaration{\Macro{geometry}} und 
  \InlineDeclaration{\Macro{newgeometry}} definieren. Für Hinweise zur weiteren 
  Verwendung des Paketes \Package{geometry} ist dessen Dokumentation zu nutzen.
\end{DeclareValues}
\end{Declaration}
...
\InlineDeclaration{\Option{BCOR=\PLength}} zu erwähnen. Mit dieser kann bei der 
Satzspiegelberechnung ein Heftrand respektive eine Bindekorrektur 
...
beiden \KOMAScript-Optionen \InlineDeclaration{\Option{headinclude=\PBoolean}} 
sowie \InlineDeclaration{\Option{footinclude=\PBoolean}}. 
...
\Environment{tudpage/columns=\PSet{Anzahl}} der Inhalt der gegebenen Anzahl 
entsprechend mehrspaltig gesetzt. Mit dem Parameter 
\Environment{tudpage/pagestyle=\PSet{Seitenstil}} kann der gewünschte  
\PageStyle{tudheadings}"=Seitenstil angepasst werden, wobei \PValue{headings}, 
\PValue{plain} und \PValue{empty} gültig sind. 
...
\InlineDeclaration=any,left,right={\Option{open=\PMisc}} 
...
\InlineDeclaration{\Option{cleardoublepage=\PMisc}} der Seitenstil eingestellt 
werden.
...
werden mit \InlineDeclaration{\Environment{abstract/markboth=false}} verwendet. 
...
\InlineDeclaration{\Environment{abstract/markboth=\PName{Kolumnentitel}}} wird 
...
löschen. Sollte der Parameter \Environment{abstract/markboth} aktiviert werden, 
...
beeinflussen. Mit \InlineDeclaration{\Environment{declarations/markboth=true}} 
...
\InlineDeclaration{\Environment{declarations/markboth=false}} werden je nach 
gewählter Option für das Paket \Package{scrlayer-scrpage} automatische oder 
manuelle (\Option{automark}/\Option{manualmark}) Kolumnentitel genutzt. Mit 
\InlineDeclaration{\Environment{declarations/markboth=\PName{Kolumnentitel}}} 
lassen sich diese auch manuell festlegen.

Wird der Parameter \Environment{declarations/markboth} in irgendeiner Form 
genutzt, wird der Seitenstil \PageStyle{headings} automatisch aktiviert. 
