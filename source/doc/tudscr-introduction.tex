...
\Macro{TUDoption}[\Parameter{Option}\Parameter{Werteliste}] definiert. Damit 
...
und Optionen gesetzt. Diese bedingten Voreinstellungen werden durch \enquote{%
  Standardwert:\,\PName{Wert}%
  \PValue{\,|\,}Bedingung:\,\PName{bedingter~Wert}%
} angegeben. Wird ein Schlüssel durch den Benutzer \emph{ohne} eine 
Wertzuweisung genutzt, so wird~-- falls vorhanden~-- ein vordefinierter 
...
\ToDo[doc]{%
  Hinweis auf Win 7 x64
  \url{http://latex.wcms-file3.tu-dresden.de/phpBB3/viewtopic.php?t=359}
}[v2.05]
