...
benötigt. Zusätzlich müssen weitere Pakete verfügbar sein, welche unter 
\autoref{sec:packages:needed} aufgeführt sind. Beim Einsatz einer der 
Distributionen
\index{Distribution}%
...
diese auch installiert sein. Weitere Hinweise dazu sind in 
\autoref{sec:install:fonts} zu finden.  Um diese zu aktivieren, sei auf 
...
\InlineDeclaration{\Class{tudbook}} aus dem Vorlagenpaket von Klaus Bergmann 
...
\TUDScript"=Posterklasse \Class{tudscrposter} umgestellt werden. In allen 
Fällen kann dabei das Paket \Package{tudscrcomp} für einen einfacheren Umstieg 
zum Einsatz kommen. 

Für alle weiteren Klassen des besagten Vorlagenpakets von Klaus Bergmann
...
bereits mehrere Stile, die im \GitHubRepo{tud-cd}[] zu finden sind. 
