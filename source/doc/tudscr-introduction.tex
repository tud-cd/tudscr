...
Geschäftsschreiben auf Basis des \KOMAScript-Klasse \Class{scrlttr2} 
...
\TUDScript-Klassen ließe sich das Paket \Package{scrletter} nutzen.
...
\autoref{sec:packages:needed} aufgeführten \Lettering{LaTeX}-Paketen~-- seit 
...
\Macro'none'(\Bundle{koma-script}){KOMAoptions|\MPName{Optionenliste}}
lassen sich beliebig viele Schlüsseln jeweils genau einen Wert zuweisen, 
\Macro'none'(\Bundle{koma-script}){KOMAoption|\MPName{Option}\MPName{Werteliste}}
