...
\Macro{KOMAoptions}[\MPName{Optionenliste}](\Package{koma-script})
lassen sich beliebig viele Schlüsseln jeweils genau einen Wert zuweisen, 
\Macro{KOMAoption}[\MPName{Option}\MPName{Werteliste}](\Package{koma-script})
...
\begin{Entity}{\Package{koma-script}}
