...
zusätzlich zu \Lettering{LaTeX} selbst ein \Application*{Perl"~Interpreter} 
sowie \Application*{Ghostscript} mitgeliefert, wodurch die Ad"~hoc"=Verwendung 
...
und \Macro{TUDoption|\MPName{Option}\MPName{Werteliste}} definiert. Damit kann 
...
wenn eine wissenschaftliche Arbeit mit \Lettering{LaTeX} verfasst werden soll.
Abschließend werden verschiedenste Pakete vorgestellt, die nicht speziell für 
das \TUDScript-Bundle selber sondern auch für andere \Lettering{LaTeX}"~Klassen
...
\Lettering{LaTeX} beschrieben, um kleinere oder größere Probleme zu lösen.
...
\hrfn{%
  https://tu-dresden.de/cd/vorlagen/druck/latex%
