...
\ChangedAt{%
  ...
  v2.04!Installationsskripte robuster und verbessert sowie für die beiden 
    portablen Distributionen \Distribution*{\hologo{TeX}~Live~Portable} und
...
\ToDo[doc]{Hinweis auf Win 7 x64}[v2.05]
%http://latex.wcms-file3.tu-dresden.de/phpBB3/viewtopic.php?t=359
