...
beziehungsweise \Distribution{\hologo{MiKTeX}~Portable}|?|. Der Vorteil dieser 
Distribution liegt zum einen in der Wartung durch mehrere Autoren sowie der 
früheren Verfügbarkeit aller Updates über CTAN. Zum anderen liefert 
\Distribution{\hologo{TeX}~Live}|?| zusätzlich zu \hologo{LaTeXe} einen 
...
%
\ChangedAt{%
  v2.04!Installationsskripte für \Distribution*{\hologo{MiKTeX}~Portable} 
  erweitert
}
%
...
Installationspfad zu verwenden. Für \Distribution{\hologo{MiKTeX}~Portable}|?| 
