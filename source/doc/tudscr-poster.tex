...
%x \webpage: neu 
%x optionale Einträge für Kopf-Felder
\chapter[Die Klasse tudscrposter]{Die Posterklasse}
\label{sec:poster}
\begin{Declaration!}[v2.05]{\Class{tudscrposter}}
\printchangedatlist%
\index{Posterklasse|!}%
%
...
\printdeclarationlist%
\ToDo[imp]{Konflikt auflösen, Label und Eintrag im Index separat}[v2.05]
%
...
\ToDo[doc]{Tabelle mit empfohlenen Schriftgrößen}[v2.05]
