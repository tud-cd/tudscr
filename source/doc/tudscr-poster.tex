...
sich mit \Option{paper=\PSet{Papierformat}}(\Package{typearea}) unter anderem 
...
\Option{paper=\PSet{Höhe:Breite}}(\Package{typearea}) gewählt werden. Für 
...
\itemval{\PSet{Farbe}}
  Die angegebene \PSet{Farbe} wird im Hintergrund für das Poster genutzt. 
...
\ToDo{in Hauptklassen übernehemen?}[v2.07]
\ToDo{Verweis auf \Environment*{figure-} und \Environment*{table-}}[v2.07]
