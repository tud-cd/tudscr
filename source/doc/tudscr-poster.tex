...
\Option{fontsize=\PLength}(\Package{koma-script})|declare| 
...
\end{tabular}
    ...
    \caption{%
      ...
      (\Option{fontsize}(\Package{koma-script}))%
    }%
...
%
\begin{Declaration}[v2.06f]{\Environment{figurehere}}
\begin{Declaration}[v2.06f]{\Environment{tablehere}}
\printdeclarationlist%
%
...
[\Parameter{Typ}\Parameter{Beschriftung}](\Package{koma-script}) nutzen. 
