...
sich mit \Option{paper=\PValueName{Format}}(\Package{typearea}) unter anderem 
...
\Option{paper=\PValueName{Höhe{:}Breite}}(\Package{typearea}) gewählt werden. 
...
\Option{fontsize=\PName{Schriftgröße}}(\Package{koma-script})|declare| 
