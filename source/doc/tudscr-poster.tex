...
\chapter[Die Posterklasse \ClassRaw{tudscrposter}{\BooleanFalse}]{%
  Die Posterklasse\InlineDeclaration*{\Class{tudscrposter}}
}
\index{Posterklasse|!}%
%
\begin{Entity'}[%
...
Beschriftung den Befehl \Macro{captionof}%
[\Parameter{Typ}\Parameter{Beschriftung}](\Bundle{koma-script}) nutzen. 
