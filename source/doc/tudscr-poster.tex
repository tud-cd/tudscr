...
\begin{Declaration}[v2.06]{\Environment{figurehere}}
\begin{Declaration}[v2.06]{\Environment{tablehere}}
\printdeclarationlist%
%
...
\Macro{captionof}[\Parameter{Typ}\Parameter{Beschriftung}](\Package{koma-script})
