...
\Macro{subtitle}, \Macro{subject} und \Macro{titlehead} 
...
\Environment{multicols}"~Umgebung aus dem Paket 
\Package{multicol} sehr empfehlenswert. 

Zur Festlegung des Papierformats ist die \KOMAScript-Option 
\Option{paper=\PMisc} zu verwenden. Dabei lassen 
sich mit \Option{paper=\PSet{Papierformat}} unter anderem 
...
\Option{paper=\PSet{Höhe:Breite}} gewählt werden. Für 
...
\Option{fontsize=\PLength} angegeben werden. Für eine 
...
\Macro{captionof}[\MPName{Typ}\MPName{Beschriftung}] 
...
Einstellungen an \Macro{hypersetup} aus besagtem Paket 
