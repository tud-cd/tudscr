...
\Option{paper=\PMisc}(\Package{typearea})'none'|declare| zu verwenden. Dabei 
lassen sich mit \Option{paper=\PSet{Format}}(\Package{typearea})'none' 
...
\Option{paper=\PSet{Höhe}{:}\PSet{Breite}}(\Package{typearea})'none'
...
\Option{fontsize=\PName{Schriftgröße}}(\Bundle{koma-script})'none'|declare|
...
\end{tabular}
    ...
    \caption{%
      ...
      (\Option{fontsize}(\Bundle{koma-script})'none')%
    }%
