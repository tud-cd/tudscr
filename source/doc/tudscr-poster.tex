...
\Macro{subtitle}, \Macro{subject} und \Macro{titlehead}(\Bundle{koma-script}) 
...
Befehle für den Schmutztitel \Macro{extratitle}(\Bundle{koma-script}) sowie 
\Macro{frontispiece}(\Bundle{koma-script}) nutzen, wobei deren Verwendung für 
...
\Macro*{date}, \Macro*{publishers}(\Bundle{koma-script}) und 
\Macro*{dedication}(\Bundle{koma-script}) sowie 
\Macro*{uppertitleback}(\Bundle{koma-script}) und 
\Macro*{lowertitleback}(\Bundle{koma-script}) haben bei der Klasse 
