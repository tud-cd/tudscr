...
\Option{paper=\PName{Format}}(\Package{typearea})'none'|declare| zu verwenden. 
...
Die mit \Macro{emailaddress} angegebene E-Mail-Adresse wird als Link definiert, 
falls das Paket \Package{hyperref} geladen wird. Über das optionale Argument 
können beliebige Einstellungen an \Macro{hypersetup}(\Package{hyperref})'none' 
aus besagtem Paket übergeben werden. Mit der Sternversion \Macro{emailaddress*} 
kann die Formatierung des Eintrags im Argument~-- gegebenenfalls lokal in einer 
...
\ToDo[doc]{\Option*{bleedmargin}}[v2.05]
\ToDo[doc]{\Option*{backgroundcolor}}[v2.05]
% Überfüllung oder Beschnittzugabe (InDesigN: Anschnitt)
\ToDo[doc]{Querverweis auf TaT-Abschnitt zu Schnittmarken}[v2.05]
\end{Bundle*}
