...
nicht immer einfach zu finden sind. Mit der Datei \File{symbols-a4.pdf} werden 
...
\hrfn{http://detexify.kirelabs.org/classify.html}{Link} verwendet werden. Auf 
...
\section{Lokale Änderungen in einer Gruppierung}
\ToDo[doc]{text}[v2.02]
\begin{quoting}
\begin{Code}[escapechar=§]
\begingroup
