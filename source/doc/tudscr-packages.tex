...
%  \Attention{%
%    Wird direkt nach einer mit \Package{noindentafter} angepassten Umgebung 
%    ein Gliederungsbefehl (\Macro*{chapter}, \Macro*{section} etc.) genutzt, 
%    werden die durch diese normalerweise eingefügten vertikalen Abstände nicht 
%    verwendet.
%  }
  \ToDo[doc]{%
    Warnung entfernen, wenn vorgeschlagene Implementierung übernommen wurde
  }[v2.02]
  \ToDo[imp]{%
    Warnung ggf. aktivieren und eigenes Paket bzw. Anwenderschnittstelle in 
