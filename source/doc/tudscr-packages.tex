...
\vspace*{\dimexpr\parskip+\baselineskip+\medskipamount\relax}%
\begin{packages}
...
\item[selinput,inputenc]\index{Eingabekodierung}
...
\begin{packages}
\item[standalone]
  \ChangedAt{v2.02!Klasse \Class{standalone}: Probleme behoben}
...
\item[xkeyval,keyval,kvoptions,pgfkeys]\index{Befehle!Deklaration}
