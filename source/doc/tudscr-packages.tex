...
\item[isodate]\index{Datum|?}
  ...
  wurden,%
  \footnote{%
    \Macro{date}, \Macro{dateofbirth} und \Macro{defensedate} sowie 
    \Macro{duedate}(tudscrsupervisor) und \Macro{issuedate}(tudscrsupervisor) 
    aus dem Paket \Package{tudscrsupervisor}
  }
