...
\item[pstricks]
  ...
  über den Pfad \Path{latex\,>\,dvips\,>\,ps2pdf} in PDF"~Dateien gewandelt 
  werden. Diese lassen sich von \Engine{pdfLaTeX} anschließend als Abbildungen 
  einbinden. Um dieses Vorgehen zu ermöglichen, können folgende Pakete genutzt 
  werden:
  %
  \begin{packages}
  \item[pst-pdf]
