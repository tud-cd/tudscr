...
\item[koma-script,typearea,scrbase,scrlayer-scrpage,scrletter]
  ...
  \end{Declaration*}
\item[opensans]
  Dieses Paket stellt die Schriftfamilie \OpenSans sowohl für den Fließtext als 
  auch den mathematischen Satz zur Verfügung. Es enthält alle notwendigen 
  Schriftschnitte sowohl im PostScript- als auch im OpenType"=Format.
\item[mweights]
  \index{Schriftstärke}%
  \ChangedAt{%
    v2.06:Paket \Package{mweights} ist für \TUDScript zwingend notwendig%
  }%
