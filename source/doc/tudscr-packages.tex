...
\item[opensans]
  ...
  nötigen Schriftschnitte sowohl im PostScript- als auch im OpenType"=Format. 
  Wird \OpenSans auch für den mathematischen Satz verwendet (\Option{cdmath}) 
  und es werden zusätzliche Symbole benötigt, so wird empfohlen, auf das Paket 
