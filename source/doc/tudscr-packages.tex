...
%
\begin{packages}
\item[typearea,scrbase,scrlayer-scrpage,scrextend]
  \InlineDeclaration*{\Class{scrbook}}
  \InlineDeclaration*{\Class{scrreprt}}
  \InlineDeclaration*{\Class{scrartcl}}
  \InlineDeclaration*{\Class{scrlttr2}}
  \ChangedAt{%
  ...
  ist die zentrale Grundlage für \TUDScript. Neben den 
