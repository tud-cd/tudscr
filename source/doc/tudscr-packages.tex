...
\ToDo[doc,imp]{hfbright und cm-super (type1ec.sty hfbright.map)}[v2.04]
...
\item[fixltx2e]
  ...
  \ToDo[doc,nxt]{Hinweise auf \Package*{fixltx2e} entfernen}[2015/01/01]
\item[mparhack]
...
\item[etex]
  ...
  wurde.
  \ToDo[doc,nxt]{Hinweise auf \Package*{etex} entfernen}[2015/01/01]
\end{packages}
