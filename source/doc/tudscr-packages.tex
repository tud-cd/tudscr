...
\begin{packages}
\item[%
  koma-script,typearea,scrbase,scrlayer-scrpage,scrletter,scrextend,scrwfile%
  ...
  Für die Bereitstellung der \PageStyle{tudheadings}()"=Seitenstile ist das 
  Paket \Package{scrlayer-scrpage} notwendig. Wenn es nicht durch den 
  Anwender~-- mit beliebigen Optionen~-- geladen wird, erfolgt dies am Ende der 
  Präambel automatisch durch \TUDScript.
  \end{Declaration*}
  \end{Declaration*}
  \end{Declaration*}
  \end{Bundle}
...
\item[quoting]
  ...
  \Option{parskip=\PSet}(\Package{koma-script})|declare| ignoriert. Mit der 
