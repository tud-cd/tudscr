...
\item[koma-script,typearea,scrbase,scrlayer-scrpage,scrextend]<koma-script>
  \begin{Declaration*}{\Class{scrbook}(\Package{koma-script})}
  \begin{Declaration*}{\Class{scrreprt}(\Package{koma-script})}
  \begin{Declaration*}{\Class{scrartcl}(\Package{koma-script})}
  \begin{Declaration*}{\Package{scrletter}(\Package{koma-script})}
  \ChangedAt{%
