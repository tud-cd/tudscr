...
\ListOfToDo
\ToDo[imp]{Kompatibilitätsmodus v2.01 zu später (Umbenennungen)}[v2.03]
\ToDo[imp]{Kompatibilitätsmodus v2.02 zu später (Satzspiegel~-- DDC)}[v2.03]
\ToDo[doc]{Option \Package{extrafootheight} dokumentieren}[v2.03]
\ToDo[doc]{Hinweis auf \Package{pagecolor} anpassen}[v2.03]
\ToDo[doc]{Hinweis auf \Package{afterpage} anpassen}[v2.03]
