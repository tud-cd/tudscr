...
\setpartpreamble{%
  \begin{abstract}
    ...
    (\InlineDeclaration*{\Bundle{tudscr}}). Hier findet der Anwender alle 
    verfügbaren Optionen, Umgebungen und Befehle, die über die Funktionalität 
    von \KOMAScript{} hinausgehen.
  \end{abstract}
}%
