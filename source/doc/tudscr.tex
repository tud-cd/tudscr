...
\setpartpreamble{%
  \begin{abstract}
    ...
    Hier findet der Anwender alle verfügbaren Optionen, Umgebungen und Befehle, 
    die über die Funktionalität von \KOMAScript{} hinausgehen.
  \end{abstract}
}%
\part[Das \TUDScript-Bundle]{%
  Das \TUDScript-Bundle%\InlineDeclaration*{\Bundle{tudscr}}
}
\label{part:main}
...
\ToDo[doc]{installation und obsolete tauschen}[v2.07]
\part{Anhang}
\appendix
