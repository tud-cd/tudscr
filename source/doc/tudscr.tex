...
\setpartpreamble{%
  ...
  \ChangedAt*{%
    ...
    v2.01b!Bug im Paket \Package*{tudscrsupervisor} bei der Aufgabenstellung 
      \Environment*{task} behoben,%
    v2.01a!Bug bei der Verwendung des Untertitels (\Macro*{subtitle}) behoben,%
    v2.01!Fehlerkorrekturen beim Kerning der Ziffern,%
    v2.01!Bugfix bei der Schriftstärke auf Titelseite (\Macro*{makebtitle}),%
    v2.00!Generalüberholung und komplette Neuimplementierung,%
    v2.00!Robustheit der Befehle und Optionen erhöht,%
