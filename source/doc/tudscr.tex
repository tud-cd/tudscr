...
\documentclass[english,ngerman,ToDo=imp]{tudscrman}
...
\ListOfToDo
\ToDo[imp,nxt]{Rückseite bei Teile- und Kapitelseiten gestaltbar?}[v2.xx]

\ToDo[imp,nxt]{NeedsTeXFormat LaTeX2e 2015/01/01}[2015/01/01]

\ToDo[imp,nxt]{Patches \Macro*{@@makechapterhead} + \Macro*{@part}}[v3.17]
\ToDo[rls,nxt]{ggf. notwendige KOMA-Script-Version anpassen (LoadClass)}[v3.17]

\ToDo[rls]{Installationsskripte auf GitHub aktualisieren, auch tudscrold}[v2.04]
\ToDo[doc]{%
  \Macro{tudheadingsfoot} und \Macro{tudheadingsfootcontent} dokumentieren%
}[v2.04]
%\tudheadingsfoot[\color{red}]{\bla}[\bla]
