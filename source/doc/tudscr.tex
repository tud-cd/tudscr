...
\documentclass[english,ngerman,ToDo=doc]{tudscrman}
...
\ToDo[rls]{notwendige/empfohlene KOMA-Script-Version anpassen (LoadClass)}
\ToDo[imp]{ToDo-Option erweitern, Ausgabe auf bestimmten Typ beschränken}[v2.03]
\end{document}
