...
\ListOfToDo
\ToDo[doc]{\File{tudscrsource.tex} auf bad boxes überprüfen}[v2.02]
\ToDo[imp]{Beim Erstellen eines Releases Index für Tutorial erzeugen}[v2.02]
\ToDo[man]{Layout und Umbrüche kontrollieren, insbesondere im Index}
