...
\ListOfToDo
\ToDo[imp]{%
  \File{tudscr-manual.dtx} nach Klasse und Paket strukturieren, 
  \Package{hyperref} \enquote{eher laden}, \Package{scrwfile} nur für Paket
}[v2.02]
\ToDo[imp]{%
  \Option*{abstract} und \Option*{declaration}: Schlüssel \PValue{leveldown} 
  sowie Schlüssel und Parameter \PValue{markboth} dokumentieren
}[v2.02]
