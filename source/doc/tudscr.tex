...
\begin{document}
\ToDo[rls]{%
  ggf. Namen des Paketes \Package{opensans} für \OpenSans korrigieren%
}[v2.06]
\ToDo[rls]{Index und Änderungsliste prüfen}[v2.06]
\ToDo[rls]{in tudscr-manual.dtx \Macro{Univers} und \Macro{DIN} ändern}[v2.06]
\renewcommand*\Univers{\ClassWarning{tudscrmanual}{Univers}Univers\xspace}
\renewcommand*\DIN{\ClassWarning{tudscrmanual}{DIN Bold}DIN~Bold\xspace}
