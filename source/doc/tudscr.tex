...
\setpartpreamble{%
  ...
  \ChangedAt*{%
    ...
    v2.02!Umbenennung einiger Befehle für Kompatibilität zu anderen Paketen{,} 
      siehe hierzu \glqq Umbenennungen\grqq{} in der Änderungsliste,%
  }%
}%
...
\ListOfToDo
\ToDo[imp]{\File{tudscr-manual.dtx} nach Klasse und Paket strukturieren}[v2.02]
\ToDo[imp]{%
  \Option*{abstract} und \Option*{declaration} um Schlüssel \PValue{leveldown} 
  erweitern
}[v2.02]
