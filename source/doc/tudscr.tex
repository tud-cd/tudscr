...
\setpartpreamble{%
  ...
  \ChangedAt*{%
    ...
    v2.03!Anpassungen interner Befehle an neue \KOMAScript-Version~v3.15,%
  }%
}%
...
\ListOfToDo
\ToDo[doc]{Bugfix Cover und Titel (Satzspiegel), Frontmatter (Seitenstil, 
Kolumnentitel)}[v2.03]
\ToDo[doc]{Kompatibilitätsmodus v2.02 zu später (Satzspiegel~-- DDC),Option 
\Option{tudscrver}}[v2.03]
\ToDo[doc]{interne Anpassungen an v3.15, Gliederungen (Fix Satzspiegel)}[v2.03]
\ToDo[doc]{Option \Option{extrabottommargin} dokumentieren}[v2.03]
\ToDo[doc]{\Package{typearea}: \Option{footheight} wird unterstützt?}[v2.03]
