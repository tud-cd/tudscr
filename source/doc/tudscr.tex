...
\ListOfToDo
\ToDo[imp]{Unterstützung für algorithm2e o.ä.}[v2.04]

\ToDo[rls,nxt]{Kapitel 5 und 6 sowie Tutorials separat veröffentlichen}

\ToDo[imp]{Unix-Skripte für portable Distribution?!}[v2.04]
\ToDo[imp]{updmap(-sys) für Unix-Skripte}[v2.04]
\ToDo[imp]{variabler Pfad für Unix-Skripte}[v2.04]

\ToDo[imp,nxt]{%
  \Package*{tudscrlayout} (\url{https://github.com/tud-cd/tud-cd/issues/6})%
}[v2.xx]

\ToDo[rls]{TeXstudio: tudscr.cwl erneuern, tudscrposter.cwl erstellen}[v2.04]

\ToDo[rls]{Installationsskripte auf GitHub aktualisieren, auch tudscrold}[v2.04]

\ToDo[rls]{notwendige KOMA-Script-Version ggf. anpassen (LoadClass)}[v3.18]
...
x cd: Wert barcolor neu 
x cdchapter: Wert barcolor neu 
x cdcover: Wert barcolor neu 
x cdpart: Wert barcolor neu 
x cdtitle: Wert barcolor neu 

x cdhead: Wert barcolor neu 
...
\abovecaptionskip: Wert abhängig von der Schriftgröße 
\bigskipamount: Wert abhängig von der Schriftgröße 
\columnsep: Wert abhängig von der Schriftgröße 
\medskipamount: Wert abhängig von der Schriftgröße 
\smallskipamount: Wert abhängig von der Schriftgröße 
