...
\ListOfToDo
\ToDo[doc]{%
  Markup von \Macro*{Macro} ändern in: 
  mainclasses,
  obsolete,
  packages,
}[v2.05]
...
\ToDo[imp]{Fußnoten in Tutorials werden nach Titel nicht zurückgesetzt}[v2.05]
\ToDo[doc]{Überprüfung Label und overfull box in Tutorials}[v2.05]

\ToDo[imp]{alle Links auf ttp://www.ctan.org/pkg automatisieren}[v2.05]
...
\ToDo[imp]{TeXstudio: tudscrman.cwl erneuern}[v2.05]
