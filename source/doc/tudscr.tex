...
\ToDo[imp,nxt]{\Macro*{DeclareSectionCommand}}[v2.06]
\ToDo[imp,nxt]{Unterstützung für algorithm2e o.ä. (Überschriften?!)}[v2.06]
...
% §§§ fehlerhafte Einträge im Index
macros:evaluation
macros:notice
macros:task

% §§§ entfernen von 
% [34pdfTeX warning (ext4): destination with the same identifier (name{table.2.1
%}) has been already used, duplicate ignored

% was hat's auf sich mit 
% 1. Package babel Info: Redefining ngerman shorthand
% 2. Package marginnote Info: 
