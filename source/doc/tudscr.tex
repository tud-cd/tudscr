...
\title{%
  Ein \NoCaseChange{\hologo{LaTeX}}-Bundle für Dokumente im~neuen \CD der \TnUD
}
\ifdef{\tudprintflag}{%
...
\ChangedAt*{%
  ...
  v2.06:\OpenSans als neue Schrift im \TUDCD, separate Schriftinstallation 
...
\label{part:main}
\ToDo[doc]{Optionen \Option{cdoldfont} und \Option{ttfont}}[v2.06]
\ToDo[doc]{Hinweise zu \Package{textcase} und dazugeh. Befehlen raus}[v2.06]
...
\ToDo[imp]{Paket für \Package*{glossaries}-Stile}[v2.07]

\ToDo[imp]{TeXstudio: alle cwl über docstrip, separate .ins-Datei}[v2.07]
\ToDo[imp]{TeXstudio: tudscrposter.cwl erstellen}[v2.07]
\ToDo[imp]{TeXstudio: tudscrmanual.cwl/tudscrtutorial.cwl erneuern}[v2.07]

\ToDo[rls]{in tudscr-manual.dtx \Macro{Univers} und \Macro{DIN} ändern}[v2.06]
