...
\ToDo[imp]{tudscrman2 in tudscr-manual.dtx}[v2.02]
\ToDo[man]{tudscr-test in Unterdateien mergen}[v2.02]
\ToDo[imp]{IfNoValueTF ggf. in NoValueT und NoValueF}[v2.02]
\ToDo[imp]{DeclarePackage und DeclareClass via Umgebung Declaration*}[v2.02]
\end{document}