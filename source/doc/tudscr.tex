...
\ToDo[doc]{cm-super und hfbright Schriften}[v2.04]
\ToDo[imp]{Hinweis auf \Package{acronym} in treatise.pdf}[v2.04]
\ToDo[doc]{\Package{luainputenc}}[v2.04]%\usepackage[utf8]{luainputenc}
