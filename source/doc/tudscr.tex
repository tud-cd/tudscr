...
\ToDo[doc]{%
  Erweiterung des Tutorials \File*{treatise.tex} mit der exemplarischen 
  Anwendung von \Package{acro} und \Package{glossaries}%
}[v2.x]
\end{document}