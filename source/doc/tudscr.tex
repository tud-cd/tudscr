...
\renewcommand*\filemodCmp[2]{%
  \IfFileExists{#2}%
    {\IfFileExists{#1}{\expandafter\@firstoftwo}{\expandafter\@secondoftwo}}%
...
\title{Ein \Lettering{LaTeX}-Bundle für Dokumente im \TUDCD}
\subtitle{%
...
\ToDo[doc]{Trennungen \"\~ und \"= sowie mit -\bsc w in .tex prüfen}[v2.07]
