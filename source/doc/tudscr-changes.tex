...
\Option*(\Package{typearea}){footinclude} direkt weitergereicht, sodass diese 
...
Die Optionen \Option*{barfont} und \Option*{widehead} wurden in der 
...
\Macro*(\Package{scrbase}){AfterPackage|\MPValue{fontspec}\MPValue{\dots}} 
...
wurde. Hierfür wird intern \Macro*(\Package{textcase}){MakeTextUppercase} aus 
...
\Macro*(\Package{textcase}){MakeTextUppercase|%
