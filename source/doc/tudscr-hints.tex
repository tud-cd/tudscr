...
Verhalten für Dokumente, die mit \Engine{pdfTeX} erzeugt werden, zu 
...
\item Der Befehl
  ...
  hat auf Low"~Level"~Ebene das gleiche Verhalten und lässt sich auch ohne  
  \Package{hyperref} nutzen.
\end{enumerate}
%
...
und am unteren Rand der Seite (\Counter*{bottomnumber}) sowie im zweispaltigen 
