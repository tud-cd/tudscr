...
aktuell erzeugte Dokument in einer PDF"~ oder einer DVI"~Datei ausgegeben wird, 
das Makro \Macro{ifpdf}(\Package{iftex}) bereit. Dies wird genutzt, um abhängig 
vom Ausgabeformat unterschiedliche Quelltexte auszuführen und somit die 
