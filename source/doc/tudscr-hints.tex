...
(\KOMAScript-Option \Option*{parskip=false}(\Bundle{koma-script})), kann es 
...
Grafiken enthält. Das Paket \Package{iftex} stellt zur Unterscheidung, ob das 
aktuell kompilierte Dokument in einer PDF"~ oder einer DVI"~Datei ausgegeben 
wird, das Makro \Macro{ifpdf}(\Package{iftex}) bereit. Dieser Befehl wird 
