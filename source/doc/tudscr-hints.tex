...
lokal mit \Macro{defcounter}[\Parameter{Zähler}](\Package{etoolbox})'none' aus 
dem Paket \Package{etoolbox} erfolgen. Die möglichen Werte liegen zwischen 
...
\ToDo[doc]{erweiterte Definition dokumentieren}[v2.05]
%\usepackage{filemod}
