...
%\hologo{LyX} \hologo{TeX}
%
%\hologoRobust{LyX} \hologoRobust{TeX}
%
%\Application{\hologo{TeX}}
%
%\Distribution{\hologo{TeX}}

\begin{theindex}
  \item \Application {\hologo {TeX}~Live}
  \item \Distribution {\hologo {TeX}~Live}
%  \item \Application {\hologoRobust {TeX}lipse}
\end{theindex}
