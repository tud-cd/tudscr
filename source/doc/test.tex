...
\begin{Declaration}[v2.06!bla]{\Macro{course}\Parameter{Studiengang}}
...
\begin{Declaration}[%
  v2.02,
  v2.03!\ReplacedBy{\Macro{discipline}}%
]{\Macro{branch}\Parameter{Studienrichtung}}{%
  \emph{entfällt}, \see*{\Macro*{discipline}'page'}%
}
\Replace[terms]{v2.04}{\Term{disciplinename}}{\Term{branchname}}
...
\begin{Declaration}[%
  v2.02,
]{\Macro{test}\Parameter{Studienrichtung}}{%
  \emph{entfällt}, \see*{\Macro*{discipline}'page'}%
}
\printdeclarationlist%
%
...
\index[macros]{bla@\Macro{bla}|see{\Macro{test}(\Package{tudscrsupervisor})}}
