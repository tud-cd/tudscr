...
\Font{titlepage} und \Font{thesis} als auch die durch \KOMAScript{} definierten 
\Font{titlehead}, \Font{subject}, \Font{title}, \Font{subtitle}, \Font{author}, 
und \Font{publishers} unterstützt.
...
\begin{Declaration}[v2.02]{\Key{\Macro{maketitle}}{cdcover}[\PSet]}
\begin{Declaration}[v2.02]{\Key{\Macro{maketitle}}{cdfont}[\PSet]}
\begin{Declaration}[v2.02]{\Key{\Macro{maketitle}}{widehead}[\PBoolean]}
\begin{Declaration}{%
