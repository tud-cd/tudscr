...
über die Option~\Option*(\Bundle{koma-script}){fontsize} notwendig ist. 
...
auswählen. Alternativ kann auch \Option*{cdfoot=tudmathposter} respektive 
\Option*{cdfoot=tudscrposter} zum Aktivieren beziehungsweise Deaktivieren 
verwendet werden.
\end{Declaration}
...
\Macro*(\Package{geometry}){geometry/layoutoffset=\PLength} des
Befehls \Macro*(\Package{geometry}){geometry} aus dem Paket 
