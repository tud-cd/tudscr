...
erstellt wurden, auf die aktuelle Version \vTUDScript*{\TUDScript}. Es werden 
einige Optionen und Befehle bereitgestellt, welche von den zuvor genannten 
Klassen definiert werden, um das entsprechende Verhalten nachzuahmen. Damit 
soll vor allem die Kompatibilität bei einer Änderung der Dokumentklasse 
sichergestellt werden. Unter anderem wird dafür an das Paket 
\Package{tudscrcolor} die Option \Option{extended}(\Package{tudscrcolor}) 
übergeben. Ist dies nicht erwünscht, sollte das Paket mit der Option 
...
werden durch das Paket \Package{tudscrcomp} für \vTUDScript*{\TUDScript} zur 
Verfügung gestellt.
...
\Macro*{geometry/layoutoffset=\PLength} des
Befehls \Macro*{geometry} aus dem Paket \Package*{geometry} 
