...
\Key*{\Macro{geometry}(\Package{geometry})}{paper=\PSet{Papierformat}},
\Key*{\Macro{geometry}(\Package{geometry})}{layout=\PSet{Zielformat}} und 
\Key*{\Macro{geometry}(\Package{geometry})}{layoutoffset=\PLength} des
