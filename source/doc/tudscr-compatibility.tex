...
Pakete wie beispielsweise \Package{glossaries} oder das nicht ganz so 
umfangreiche Paket \Package{nomencl}. Daher wird für diese Umgebung keine 
Portierung vorgenommen, sondern lediglich die ursprüngliche Definition 
übernommen.
\end{Declaration}
\end{Declaration}
\index{Kompatibilität!\Class{tudbook}|)}%
...
Wahl der Schriftgröße über die Option~\Option*(\Bundle{koma-script}){fontsize} 
...
\Option*(\Bundle{koma-script}){parskip=half} eingestellt werden. Ein blaues 
...
\begin{Declaration}
  {\Option{bluebg}}
  <identisch zu \Option*(\Class{tudscrposter}){backcolor=true}>
\printdeclarationlist

Mit der Klasse \Class{tudscrposter} lässt sich das Verhalten mit der Option 
\Option*(\Class{tudscrposter}){backcolor} umsetzen.
\end{Declaration}
...
<identisch zu \Macro*(\Class{tudscrposter}){telephone|\MPName{Telefonnummer}}>
\begin{Declaration}
  {\Macro{fax|\MPName{Telefaxnummer}}}
  <identisch zu \Macro*(\Class{tudscrposter}){telefax|\MPName{Telefaxnummer}}>
\begin{Declaration}
  {\Macro{homepage|\MPName{URL}}}
  <identisch zu \Macro*(\Class{tudscrposter}){webpage*|\MPName{URL}}>
\printdeclarationlist
...
dass E"~Mail-Adresse und URL nicht automatisch formatiert werden.
\end{Declaration}
\end{Declaration}
\end{Declaration}
\end{Declaration}
...
\begin{Declaration}
  ...
  <\seeplain{\Macro*{footlogo}}>
\begin{Declaration}
  {\Macro{drittlogofile|\MPName{Dateiname}}}
  <\seeplain{\Option*{ddc} und \Option*{ddcfoot}}>
\printdeclarationlist
...
\begin{Declaration}
  ...
  <keine Funktionalität, \seeplain{\Macro*{headlogo}}>
\begin{Declaration}
  {\Macro{institutslogo|\MPName{Definition}}}
  <keine Funktionalität, \seeplain{\Macro*{footlogo}}>
\begin{Declaration}
  {\Macro{drittlogo|\MPName{Definition}}}
  <keine Funktionalität, \seeplain{\Option*{ddc} und \Option*{ddcfoot}}>
\printdeclarationlist
...
\Macro*(\Package{geometry}){geometry/paper=\PSet{Papierformat}},
\Macro*(\Package{geometry}){geometry/layout=\PSet{Zielformat}} und 
\Macro*(\Package{geometry}){geometry/layoutoffset=\PLength} 
des Befehls \Macro*(\Package{geometry}){geometry} aus dem Paket 
