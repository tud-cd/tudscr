...
\begin{Declaration}[v2.02/\Macro{branch}]{%
...
\begin{Declaration}[v2.02/\Macro{contact}]{%
  \Macro{contactperson}\Parameter{Kontaktperson(en)}%
}
\begin{Declaration}{\Macro{office}\Parameter{Dienstsitz}}
\begin{Declaration}[v2.02/\Macro{phone}]{%
  \Macro{telephone}\Parameter{Telefonnummer}%
}
\begin{Declaration}[v2.02/\Macro{email}]{%
...
\begin{Declaration}[v2.02/\Term{branchname}]{\Term{disciplinename}}
\printdeclarationlist%
%
...
\begin{Declaration}v2.02/\Term{contactname}{\Term{contactpersonname}}
\printdeclarationlist%
%
