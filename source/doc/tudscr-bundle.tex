...
\Class{tudfax}, \Class{tudhaus} sowie \Class{tudform} vorgesehen. Seit der 
Version~v2.04 
\ChangedAt{%
  v2.04!\Package{tudscrfonts}: Klassen \Class{tudposter} und 
  \Class{tudmathposter} werden unterstützt%
}
werden auch \Class{tudmathposter} und \Class{tudposter} unterstützt. Das Paket  
kann prinzipiell mit jeder beliebigen \hologo{LaTeXe}-Klasse verwendet werden. 
Wird keine der zuvor genannten Klassen genutzt, muss der Anwender das Setzen 
...
\printdeclarationlist%
\ToDo[doc]{Dokumentation und Konflikt auflösen}[v2.04]
%
...
\ToDo[imp,nxt]{Paket \Package*{tudscrletter} für Briefe im \CD}[v2.xx]
