...
Optionen können dabei entweder direkt als Klassenoption oder als Paketoptionen 
im optionalen Argument von 
\Macro*{usepackage}[\OParameter{Paketoptionen}\PParameter{tudscrfonts}] 
angegeben werden. Zusätzlich ist nach dem Laden des Paketes die späte 
Optionenwahl mit \Macro{TUDoption} beziehungsweise \Macro{TUDoptions} möglich.
...
Schriftfamilie verwendet. Diese unterscheidet sich von den ursprünglich durch 
die gerade genannten Klassen genutzten Schriftfamilien sehr stark. Wird nun das 
