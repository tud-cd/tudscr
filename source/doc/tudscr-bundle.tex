...
\printdeclarationlist%
%
Diese Option wird direkt an das Paket \Package{xcolor} durchgereicht. Damit 
werden bereits beim Laden des Paketes \Package{tudscrcolor} die Farben nicht 
nach dem CMYK"=Farbmodell sondern im RGB"=Farbraum global definiert.
\end{Declaration}
...
vorgesehen:
% TODO Angabe sollte nicht notwendig für index sein
\begin{itemize}
\item \Class{tudbook}()
...
hierfür die Pakete aus dem \GitHubRepo{tud-cd}[] genutzt werden.
%\end{Bundle*}
