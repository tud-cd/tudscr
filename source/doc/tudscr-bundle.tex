...
\begin{Declaration}{\Macro{setcdcolors}[\MPName{Farbmodell}]}
\printdeclarationlist%
%
...
\begin{Declaration}{\Macro{commaswap}[\MPName{Trennzeichen}]}
\begin{Declaration}{\Macro{dotswap}[\MPName{Trennzeichen}]}
\printdeclarationlist%
%
