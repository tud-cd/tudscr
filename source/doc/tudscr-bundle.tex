...
mit dem Parameter \Key{\Environment{evaluation}}{grade=\PName{Note}} angegeben, 
so wird diese innerhalb von \Term{gradetext} verwendet.
\grade{\PName{Note}}
...
sich \hologo{LaTeX}-Beamer-Präsentationen im Stil des \TUDCDs erstellt werden 
können.
%\end{Bundle!}
%
