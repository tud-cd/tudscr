...
\item[hyphsubst]\index{Worttrennung|!}
  Die möglichen Trennstellen von Wörtern wird von \hologo{LaTeX} mit Hilfe 
...
\item[relsize]\index{Schrift!Größe}
  Mit Hilfe dieses Paketes kann die Größe einer Textauszeichnung relativ zur 
...
\item[fontspec]
  Dieses Paket ermöglicht die Einbindung von Schriften im OpenType"=Format. 
  Diese müssen lediglich für das Betriebssystem jedoch nicht speziell für 
  \hologo{LaTeX}installiert sein. Allerdings ist dafür die Verwendung von 
  \hologo{LuaLaTeX} oder \hologo{XeLaTeX} zwingend notwendig.
