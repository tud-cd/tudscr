...
Nach der Ausgabe des Inhaltes der Aufgabenstellung werden der oder die 
definierten Gutachter beziehungsweise Prüfer (\Macro{referee}) sowie der oder 
die Betreuer (\Macro{supervisor}) aufgelistet. Dabei wird vor dem jeweiligen 
Namen der dazugehörige Bezeichner (\Term{refereename}, \Term{refereeothername} 
respektive \Term{supervisorname}, \Term{supervisorothername}) gesetzt. Danach 
erscheinen das Ausgabedatum (\Macro{issuedate}) sowie der verpflichtende 
...
\ToDo[doc]{\Macro{course} und \Macro{discipline} entfernen?}[v2.05]
...
\ToDo[doc]{\Term{coursename} und \Term{disciplinename} entfernen?}[v2.05]
