...
%
\begin{Declaration}{\Environment{task}[\POList{Überschrift}]}(%
...
\begin{Declaration}{\Macro{taskform}[\PList\MPName{Ziele}\MPName{Schwerpunkte}]}
\printdeclarationlist%
%
...
\index{Gutachten|!(}%
%
\begin{Declaration}{\Environment{evaluation}[\POList{Überschrift}]}(%
  \Environment{tudpage}'ref'%
)
\begin{Declaration}{%
...
\begin{Declaration}{%
  \hskip-.06em\Macro{evaluationform}[%
    \PList\MPName{Aufgabe}\MPName{Inhalt}\MPName{Bewertung}\MPName{Note}%
  \hskip-.06em]%
}
\printdeclarationlist%
%
...
\index{Aushang|!(}%
%
\begin{Declaration}{\Environment{notice}[\POList{Überschrift}]}(%
  \Environment{tudpage}'ref'%
)
...
\begin{Declaration}{%
  \Macro{noticeform}[\PList\MPName{Inhalt}\MPName{Schwerpunkte}]%
}
\printdeclarationlist%
%
