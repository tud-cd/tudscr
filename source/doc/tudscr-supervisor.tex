...
\begin{Declaration}
  {\Key{\Environment{task}}{headline=\PName{Überschrift}}}
\begin{Declaration}
  {\Key{\Environment{task}}{style=\PName{Stil}}}
  [v2.05]
...
\begin{Declaration}
  {\Key{\Environment{evaluation}}{grade=\PName{Note}}}
\printdeclarationlist
...
\begin{Declaration}
  ...
  <\Environment{tudpage}'auto'>
\begin{Declaration}
  {\Key{\Environment{notice}}{headline=\PName{Überschrift}}}
\printdeclarationlist
