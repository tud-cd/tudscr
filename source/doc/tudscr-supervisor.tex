...
\Environment{itemize}(\Bundle{koma-script},\Package{enumitem})'none'"=Umgebung
gesetzt. Deshalb \emph{muss} jedem Stichpunkt 
\Macro{item}(\Bundle{koma-script},\Package{enumitem})'none' vorangestellt 
werden.
\end{Declaration}
%
\begin{Example}
...
\begin{Declaration}{%
  \hskip-.06em\Macro{evaluationform}[%
    \OList\MPName{Aufgabe}\MPName{Inhalt}%
    \MPName{Bewertung}\MPName{Note}\hskip-.06em%
  ]%
}
\printdeclarationlist%
%
