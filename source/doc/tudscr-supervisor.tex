...
\begin{Declaration}{%
  \Macro{evaluationform}[%
    \LParameter\Parameter{Aufg.}\Parameter{Inh.}%
    \Parameter{Bew.}\Parameter{Note}%
  ]%
}
\printdeclarationlist%
%
...
darin~-- für eine strukturierte Gliederung~-- erzeugten Überschriften mit den 
...
\grade{\PName{Note}}
\TermTable*{gradetext}{.75\textwidth}
\end{Declaration}
