...
\begin{Declaration}
  {\Environment{task/headline=\PName{Überschrift}}}
\begin{Declaration}
  {\Environment{task/style=\PName{Stil}}}
  [v2.05]
...
Ausgabeformatierung des Datums mit \Macro{printdate} 
beziehungsweise \Macro{DTMDate} für \Macro{duedate} und 
...
\begin{Declaration}
  ...
  <\Environment'auto'{tudpage}>
\begin{Declaration}
  {\Environment{evaluation/headline=\PName{Überschrift}}}
\begin{Declaration}
  {\Environment{evaluation/grade=\PName{Note}}}
\printdeclarationlist
...
\begin{Declaration}
  ...
  <\Environment'auto'{tudpage}>
\begin{Declaration}
  {\Environment{notice/headline=\PName{Überschrift}}}
\printdeclarationlist
...
passende Abbildung (\Macro{includegraphics}) eingefügt 
...
\Environment{itemize}"~Umgebung zum 
