...
%\geometry{showcrop,margin=20mm}%
%\geometry{paper=a3paper,layout=a4paper,layoutoffset=1cm}
...
%\maketitle%[cd=on,cdhead=color,cdfoot=color]
%\Blinddocument
...
%\begingroup
%\let\paperheight\Gm@layoutheight
%\let\paperwidth\Gm@layoutwidth
%\recalctypearea
%\Blindtext
%\endgroup
%\clearpage
