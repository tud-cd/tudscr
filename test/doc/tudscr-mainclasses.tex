...
\itemval=custom=[v2.05]
  ...
  das Paket bereitgestellten Befehlen \InlineDeclaration{\Macro(*){geometry}} 
  und \InlineDeclaration{\Macro(*){newgeometry}} definieren. Für Hinweise zur 
  weiteren Verwendung des Paketes \Package{geometry} ist dessen Dokumentation 
  zu nutzen.
\end{DeclareValues}
\end{Declaration}
