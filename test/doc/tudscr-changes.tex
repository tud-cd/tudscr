...
\itemval=2.07=
  ...
  \sflogo{LaTeX}"~Lauf das gleiche Ausgabeergebnis liefern, muss dies mit 
...
\printdeclarationlist
%
In Anlehnung an andere \sflogo{LaTeX}"~Pakete und "~Klassen wurde 
...
\itemval=onlydin=
  ...
  sondern die \sflogo{LaTeX}"=Standardschriften respektive die eines geladenen 
