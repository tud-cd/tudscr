...
verwendete \hologo{LaTeX}"=Distribution installiert werden kann.
...
wird. Erscheint nur der Pfad der \hologo{LaTeX}"=Distribution, ist die 
...
\Path{vptovf} benötigt, welche bei \Distribution{\hologo{TeX}~Live} oder 
\Distribution{Mac\hologo{TeX}} über \Distribution*{fontware} respektive bei
\Distribution{\hologo{MiKTeX}} über \Distribution*{miktex-texware} sowie 
...
über den \Distribution{\hologo{MiKTeX}}"=Paketmanager hinzugefügt werden.
...
Schriftinstallation über den \Distribution{\hologo{TeX}~Live}"=Paketmanager 
...
Aktualisierung der \hologo{LaTeX}"=Distribution~-- müssen diese über den 
...
\item Bei der erstmaligen Verwendung von \TUDScript werden alle benötigten 
  ...
  Pakete   \Package||{etoolbox}, \Package||{xpatch}, \Package||{xcolor}, 
  \Package||{environ}, \Package||{trimspaces}, \Package||{letltxmacro} sowie 
  \Package*{mptopdf}.
\end{enumerate}
