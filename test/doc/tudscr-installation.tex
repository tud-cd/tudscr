...
jeweiligen \DistributionGeneral installiert, falls kein anderes Verzeichnis 
explizit angegeben wird. 

\Attention{%
  Vor der Ausführung des Installationsskriptes sollte~-- insbesondere bei der 
  Nutzung von \MiKTeX in der Basiskonfiguration~-- eine Aktualisierung der 
  \DistributionGeneral durchgeführt werden. Andernfalls könnte es im 
...
\Bundle*{miktex-fonts} bereitgestellt werden und zwingend installiert sein 
müssen. Das Vorhandensein der Pakete und Skripte wird durch die jeweiligen 
...
über den \MiKTeX"=Paketmanager hinzugefügt werden.
