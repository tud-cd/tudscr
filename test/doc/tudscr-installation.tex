...
Hinweis auf die Verwendung von \sflogo{LaTeX} bestellt und nach Erhalt der 
...
\minisec{Anmerkung zu \sflogo{MiKTeX}}
%
...
\minisec{Anmerkung zu \sflogo{TeXLive} und \sflogo{MacTeX}}
%
...
\item Über das Kontextmenü die Kommandozeile ausführen und in dieser das Skript 
  ...
  den Anwender über den \emph{\sflogo{TeXLive}~Manager} installiert werden.
  \Attention{%
