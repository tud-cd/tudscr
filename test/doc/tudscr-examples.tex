...
%
Hier wird gezeigt, wie die Präambel eines minimalen \sflogo{LaTeX}"=Dokumentes 
...
\TnUD, die ihre ersten Schritte mit \sflogo{LaTeX} beim Verfassen einer 
wissenschaftlichen Arbeit oder ähnlichem machen. Während der Einstiegsphase in 
\sflogo{LaTeX} kann ein Anfänger sehr schnell aufgrund der großen Anzahl an 
...
anderen \sflogo{LaTeX}"~Veteran~-- als Leitfaden für die Erstellung einer 
wissenschaftlichen Arbeit gedacht.

\section{%
  Ein Beitrag zum mathematischen Satz mit \sflogo{LaTeX}%
...
ihrem \sflogo{LaTeX}"=Dokument mathematische Formeln setzen wollen. In diesem 
...
Sollen beim Verfassen eines \sflogo{LaTeX}"=Dokumentes Daten in einem 
