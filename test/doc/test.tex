...
%\meaning\tud@markup@list
%
%\edef\tud@res@d{\csuse{Entity@Level@@Option}}%
%
%\meaning\tud@res@d
%
%\csmeaning{Entity@Level@@Option}
%
%\edef\foo{\expandafter\expandafter\expandafter\@firstoftwo%
%\csuse{Entity@Level@@Option}}
%
%\meaning\foo

%\Entity@Level@@Validate
\noindent
