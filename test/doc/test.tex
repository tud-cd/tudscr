...
%\DefaultEntity{\Bundle{A}}{
%  \DefaultEntity{\Package{Apkg}}{
%    \Option{testoption}
%  }
%}
%\DefaultEntity{\Bundle{B}}{
%  \DefaultEntity{\Package{Bpkg}}{
%    \Option{testoption}
%  }
%}

%\DefaultEntityLink{\Bundle'none'{bla}}'GH:foo'

%\DefaultEntity{\Bundle{calc}}{\Package{calc}}

%\DefaultEntity{\Application{bla}}{
%  \File{foo.zip},
%}

\DefaultEntityLink{\Package{typearea}}'CTAN:typearea'
