...
%\Macro*{TUDoption} und \Macro*{TUDoptions} ändern lassen. Weiterhin werden 
%die \PageStyle*{tudheadings}"=Seitenstile der \TUDScript-Klassen mithilfe des 
