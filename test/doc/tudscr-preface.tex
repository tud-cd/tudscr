...
In diesem Handbuch werden die für das Erstellen von \sflogo{LaTeX}"=Dokumenten 
...
bieten, welche weit über die Möglichkeiten der \sflogo{LaTeX}"=Standardklassen 
...
Kenntnisse in der Verwendung von \sflogo{LaTeX} vorausgesetzt. Sollten diese 
nicht vorhanden sein, wird das Lesen der \sflogo{LaTeXe}"=Kurzbeschreibung 
...
in \sflogo{LaTeX} stellt Nicola~L.~C.~Talbot sehr umfängliche Tutorials für 
\href{http://www.dickimaw-books.com/latex/novices/}{\sflogo{LaTeX}-Novizen} 
...
Des Weiteren sollte \emph{jeder} Anwender das \sflogo{LaTeXe}"=Sündenregister 
