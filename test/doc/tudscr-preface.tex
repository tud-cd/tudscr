...
Kenntnisse in der Verwendung von \hologo{LaTeX} vorausgesetzt. Sollten diese 
nicht vorhanden sein, wird das Lesen der \hologo{LaTeXe}"=Kurzbeschreibung 
...
in \hologo{LaTeX} stellt Nicola~L.~C.~Talbot sehr umfängliche Tutorials für 
