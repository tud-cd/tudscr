...
\File'CTANinfo:symbols/comprehensive'{symbols-a4.pdf} werden viele Symbole aus 
mehreren Paketen aufgeführt. Alternativ kann 
\href{http://detexify.kirelabs.org/classify.html}{Detexify} verwendet werden. 
...
%
\Hint{v2.05}{Einbinden von \Application{Inkscape}-Grafiken}%
...
welches einige Änderungen am \hologo{LaTeXe}"~Kernel vornimmt. Das Ziel dieses 
...
%
\Hint{v2.05}{Warnung bei der Schriftgrößenwahl}%
