...
sich für mich persönlich bei der Arbeit mit \hologo{LaTeX} bewährt haben. 
...
%
Die meisten \hologo{LaTeX}"=Entwicklungsumgebungen enthalten eine integrierte 
...
\itempkg{selinput,inputenc}
  ...
  aktuellen \hologo{LaTeX}"=Entwicklungsumgebung unterstützt wird. Dies sollte 
