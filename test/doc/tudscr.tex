...
% svg-inkscape [123]
% tudthesis [145]
% TODO bundle(koma-script):???: sollte es nicht geben 
%tudscr:cmd:DTMDate
%tudscr:cmd:bm
%tudscr:cmd:bmmax
%tudscr:cmd:boldmath
...
%\DeclareMarkupEntity{\Bundle{filecontents}}{\Package{filecontents}}
%\DeclareMarkupEntity{\Bundle{filemod}}{\Package{filemod}}
%\DeclareMarkupEntity{\Bundle{kvoptions}}{\Package{kvoptions}}
%\DeclareMarkupEntity{\Bundle{kvsetkeys}}{\Package{kvsetkeys}}
%\DeclareMarkupEntity{\Bundle{mweights}}{\Package{mweights}}
\DeclareMarkupEntity{\Bundle{environ}}{\Package{environ}}
\DeclareMarkupEntity{\Bundle{letltxmacro}}{\Package{letltxmacro}}
\DeclareMarkupEntity{\Bundle{trimspaces}}{\Package{trimspaces}}
...
\part[%
  ...
  \ChangedAt*{%
    ...
    \Package{mathastext}, \Package{iwona} und \Package{mweights} zwingend 
    erforderlich;%
...
\setpartpreamble{\ToDo[doc]{installation <-> obsolete (comp zuvor)}[v2.07]}
\part{Anhang\label{part:appendix}}
\appendix
% TODO additional, comp, obsolete, installation
...
\ToDo[doc]{Verwendung von -\bsc w in .tex suchen und prüfen}[v2.07]
...
\ToDo[rls]{Datumsangaben \emph{allee} dtx-Dateien prüfen}%: ^((?!%).)*\d{4}(/|-)
