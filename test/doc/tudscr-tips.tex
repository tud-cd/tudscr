...
\section{%
  \hologo{LaTeX}-Entwicklungsumgebungen%
  \label{sec:tips:ide}%
}
%
\ToDo[doc]{%
...
und Bearbeiten von \hologo{LaTeX}"~Dateien geeignet sind. Ich persönlich nutze 
seit langem \Application{\hologo{TeX}studio}, da dieser viele Unterstützungs- 
und Assistenzfunktionen bietet. Neben diesen gibt es noch weitere, gut nutzbare 
\hologo{LaTeX}"=Entwicklungsumgebungen. Unabhängig von der Auswahl, sollte 
...
\item \Application*{LEd}~-- früher \Application*{\hologo{LaTeX}~Editor}
\item \Application*{\hologo{LyX}}~-- grafisches Front"~End für \Format*{LaTeX}
\end{itemize}
%
...
%
Einige \hologo{LaTeX}"~Zähler werden bei der Inkrementierung eines überlagerten 
