...
%%
%\RequirePackage[cdfont=on]{fix-tudscrfonts}  
\documentclass
%[paper=a0,cdfont=nodin,MathematikA0]{tudmathposter}
[paper=a0,nodin,fontsizet=40pt]{tudscrposter}
...
\begin{tikzpicture}[%
  ultra thick,
%  scale={\ratio{\linewidth}{8.7cm}},
  anchor=center,text width=
]
  \scriptsize
