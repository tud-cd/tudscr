...
%% due to wrong code in latex-dev
\let\substdefault\textcompsubstdefault
...
\DeclareEncodingSubset{TS1}{iwona}{0}
%\DeclareEncodingSubset{TS1}{iwona}{9}
\begin{document}
\parindent=0pt
\fontfamily{iwona}\selectfont
\def\testglyph{A}
\def\wrapglyph#1{#1}
%\def\wrapglyph#1{\fbox{#1}}
%\fboxsep=0pt
