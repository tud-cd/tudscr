...
REM call :checkfile    "grkfinst.zip"
REM call :checkscript  "tftopl"       "fontware"
REM call :checkscript  "pltotf"       "fontware"
REM call :checkscript  "vptovf"       "fontware"
REM call :checkpackage "fontinst.sty" "fontinst"
...
:createfontfile
  ...
  set "file=%file:/=\%"
  copy "%file%"> nul
  REM kpsewhich %4> filepath.tmp
  REM set /p file=< filepath.tmp
  REM set "file=%file:/=\%"
  REM copy "%file%"> nul
  REM fontforge ttf2afm.ff %2 %3 %4
