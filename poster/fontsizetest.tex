...
%  geometry,%colour,cdfonts=no
%ngerman,
%fontspec,
%slantedGreek,
%slantedgreek,
%slantedgreek=true,
%class=tudscrreprtnew,
%crop=false
%class=scrreprt
%  parskip=relative,
]%
...
\makeatletter
\def\bla{%
%  \meaning\@fontsizefilebase: \@ptsize{} -- \tud@font@size\par
  \meaning\changefontsizes\par
%  \the\abovecaptionskip
}
\makeatother

%\KOMAoptions{fontsize=15pt}
%\TUDoptions{cdfontsize=15pt}
...
\providecommand{\upOmega}{<up>}
\providecommand{\varOmega}{<var>}
...
\blindtext\par
%\meaning\upOmega  $\upOmega$\par
%\meaning\varOmega $\varOmega$\par
%\meaning\Omega    $\Omega$\par
%\makeatletter
%%\meaning\tud@upOmega  $\tud@upOmega$\par
%%\meaning\tud@varOmega $\tud@varOmega$\par
%\makeatother
%
%\TUDoptions{cdfont=no}%
%
