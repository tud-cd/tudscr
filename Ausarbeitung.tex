...
\maketitle
\clearpage
\chapter[sec: lange wörter]{All die Langen wörter werden hier stehen} \label{sec: lange wörter}

\tableofcontents
\clearpage
\listofsymbols

\section{öamger title}
\cite[S.14]{numerikGrossmann}

\begin{theorem}
      \label{th: theorem 1}
      Ich werde nicht schweigend untergehen, wir werden leben, wir werden weiterleben, heute feiern wir: unseren Indepence-Day
\end{theorem}
\ref{sec: lange wörter}

\begin{definition}
      mal schauen welche nummer es hat

\end{definition}

hier wird jezt Theorem \ref{th: theorem 1} benutzt \al
\printbibliography
\end{document}
